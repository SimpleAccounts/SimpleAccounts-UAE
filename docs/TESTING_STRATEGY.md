...
_Target: Logic-heavy utility classes._
...
_Target: Controllers and Security Config._
...
- **Focus**:
  ...
  - _Reasoning_: This validates that Spring Security, Jackson, and JJWT are all talking to each other correctly.

### Layer 3: Frontend Unit/Integration Tests (High Priority)

_Target: API Layer and Routing._
...
1.  **Baseline**: Run `mvn test` and `npm test` _before_ any changes. All must pass.

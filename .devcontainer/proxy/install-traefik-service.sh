...
echo -e "  Developers launch their environment with DevPod:"
echo -e "  ${GREEN}devpod up git@github.com:SimpleAccounts/SimpleAccounts-UAE.git --provider ssh --provider-option HOST=dev-server${NC}"
echo ""

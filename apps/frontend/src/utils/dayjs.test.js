/**
 * Tests for Day.js date handling.
 * These tests verify that date formatting/parsing works correctly after migration from Moment.js.
 *
 * Migrated from Moment.js to Day.js for reduced bundle size (~330KB → ~2KB).
 */
import dayjs from '@/utils/date';

describe('Day.js Date Handling', () => {
  // ============ Basic Formatting ============
  ...
  describe('Date Parsing', () => {
    it('should parse ISO 8601 dates', () => {
      const date = dayjs('2024-01-15T10:30:00.000Z');
    ...
    it('should handle edge case dates', () => {
      ...
      const nonLeapYear = dayjs('2023-02-29', 'YYYY-MM-DD', true);

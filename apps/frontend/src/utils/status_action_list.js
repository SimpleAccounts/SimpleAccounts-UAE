...
export const QuotationStatusActionList = [
  ...
  {
    status: 'Sent',
    list: ['Draft', 'Mark As Approved', 'Mark As Rejected', 'Create A Duplicate', 'Close'],
  },
  {
    status: 'Approved',
    list: ['Create Invoice', 'Mark As Rejected', 'Create A Duplicate', 'Close'],
  },
...
export const PurchaseOrderStatusActionList = [
  ...
  {
    status: 'Sent',
    list: ['Mark As Approved', 'Mark As Rejected', 'Create A Duplicate', 'Send Again', 'Delete'],
  },
  {
    status: 'Approved',
    list: ['Create Invoice', 'Mark As Rejected', 'Create A Duplicate', 'Send Again', 'Delete'],
  },
  {
    status: 'Rejected',
    list: ['Draft', 'Mark As Approved', 'Create A Duplicate', 'Send Again', 'Delete'],
  },
  { status: 'Invoiced', list: ['Create A Duplicate', 'Send Again'] },
];

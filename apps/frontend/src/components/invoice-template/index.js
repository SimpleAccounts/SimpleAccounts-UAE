...
class TemplateComponent extends React.Component {
  ...
  render() {
    const { templateTitle, templateImg, templateId, checkdata, enable, styles } = this.props;
      ...
      <div className="theme-wrapper">
        ...
        <div className="flex gap-2 mt-2">
          ...
          <Button
            ...
            size="sm"
            className="use_theme"
            onClick={updateMailTheme(templateId, templateTitle)}
          >
            Use Theme
          </Button>
        </div>
        ...
        <Dialog open={this.state.isOpen} onOpenChange={this.closePreviewModal}>
          <DialogContent className="max-w-4xl">
            ...
            <div className="flex justify-center">
              <img
                className="preview-gallery w-full h-auto"
                src={templateImg}
                alt={templateTitle}
              ></img>
            </div>

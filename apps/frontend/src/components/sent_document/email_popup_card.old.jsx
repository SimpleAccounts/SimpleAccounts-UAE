...
const EmailPopUpModal = ({
  ...
  useEffect(() => {
    if (currentEntityEmailDetails) {
      ...
      reset({
        to_emails: currentEntityEmailDetails.billingEmail
      ...
      if (files && files.length > 0) {
        ...
        Promise.all(promises)
          .then(results => {
            ...
            setValue('attachmentFile', [...files, ...alreadyExistingFiles], {
              shouldValidate: true,
            });
    ...
    return (
      <div className="react-multi-email">
        <div
          ...
          style={{ opacity: 1, display: 'contents', flexWrap: 'inherit' }}
        >
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <Textarea
                            ...
                            value={
                              currentEntityEmailDetails.subject && currentEntityEmailDetails.subject
                            }
                          />
                        )}
                      />

    ...
    <>
      <FormGroup className="mb-3">
        <Label htmlFor={zipCodeName}>
          ...
          {countryId == 229 ? strings.POBoxNumber : strings.PostZipCode}
        </Label>
        <Input
          ...
          className={zipCodeError && zipCodeTouched ? 'is-invalid' : ''}
        />
        {zipCodeError && zipCodeTouched && <div className="invalid-feedback">{zipCodeError}</div>}
      </FormGroup>
    </>
  );
}

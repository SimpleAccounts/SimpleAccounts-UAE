...
function TermDateInput(props) {
  ...
  return (
    <>
      <Col lg={3}>
        <FormGroup className="mb-3">
          ...
          <Select
            options={
              termList
                ? selectOptionsFactory.renderOptions('label', 'value', termList, 'Terms')
                : []
            }
        ...
        <FormGroup className="mb-3">
          ...
          <DatePicker
            ...
            className={`form-control ${
              invoiceDate.errors && invoiceDate.touched ? 'is-invalid' : ''
            }`}
          />
      ...
      <Col lg={3}>
        <FormGroup className="mb-3">
          <Label htmlFor={invoiceDueDate.name}>{invoiceDueDate.label}</Label>
          <div>
            <DatePicker
              className="form-control"

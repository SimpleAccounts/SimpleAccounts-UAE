                          ...
                          onClick={() => {
                            if (editFlag === false)
                              this.props.commonActions.tostifyAlert(
                                'error',
                                strings.YouCannotEditTransactionsForWhichVATIsRecorded
                              );
                            else
                        ...
                        <DropdownItem
                          ...
                          onClick={() => {
                            if (
                              ...
                              documentTitle === strings.PurchaseOrder
                            )
                        ...
                        <DropdownItem
                          ...
                          onClick={() => {
                            if (documentTitle === strings.PurchaseOrder)
                              history.push('/admin/expense/supplier-invoice/create', {
                                poId: id,
                                renderURL: viewURL,
                                renderID: id,
                              });
                            else if (documentTitle === strings.Quotation)
                              history.push('/admin/income/customer-invoice/create', {
                                quotationId: id,
                                renderURL: viewURL,
                                renderID: id,
                              });
            ...
            <SentInvoice
              ...
              mailPopupCard={
                (documentTitle === strings.Quotation ||
                  ...
                  documentTitle === strings.TaxCreditNote ||
                  documentTitle === strings.PurchaseOrder ||
                  documentTitle === strings.IncomeReceipt) &&
                (sendAgain || !markAsSent)
              }
            />
          )}

  ...
  return (
    <div className="message-component">
      <Alert color={type} fade={false}>
        ...
        <p style={{ marginBottom: link ? '10px' : '0', color: type === 'danger' ? '#721c24' : type === 'success' ? '#155724' : 'inherit', fontSize: '14px', lineHeight: '1.5' }}>
          { content }
        </p>
        {link && (
          <a 
  ...
  render() {
    ...
    return (
      <div className="message-component">
        <Alert color={type} fade={false}>
          {title && <h5 className="alert-heading">{ title }</h5>}
          <p style={{ marginBottom: '0', color: type === 'danger' ? '#721c24' : type === 'success' ? '#155724' : 'inherit', fontSize: '14px', lineHeight: '1.5' }}>
            { content }
          </p>
        </Alert>
      </div>

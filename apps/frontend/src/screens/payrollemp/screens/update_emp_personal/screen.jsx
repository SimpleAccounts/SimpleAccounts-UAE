...
const getUpdatePersonalSchema = (sifEnabled, masterPhoneNumber) => {
  return z.object({
    ...
    ...(sifEnabled ? {
        ...
        emergencyContactNumber1: z.string().min(1, 'Contact number is required').refine((val) => val && val.length === 12, "Invalid mobile number").refine((val) => val !== masterPhoneNumber, "Please Enter Another Mobile Number"),
...
const UpdateEmployeePersonal = () => {
            ...
            try {
                ...
                if (empRes.status === 200) {
                    ...
                    form.reset({
                        ...
                        employeeDesignationId: data.employeeDesignationId ? { label: data.employeeDesignationId.label, value: data.employeeDesignationId.value } : '',
                        salaryRoleId: data.salaryRoleId ? { label: data.salaryRoleId.label, value: data.salaryRoleId.value } : '',
                        
                        // SIF / Additional
                        gender: data.gender ? (typeof data.gender === 'string' ? { label: data.gender, value: data.gender } : data.gender) : '',
                        maritalStatus: data.maritalStatus ? (typeof data.maritalStatus === 'string' ? { label: data.maritalStatus, value: data.maritalStatus } : data.maritalStatus) : '',
                        presentAddress: data.presentAddress || '',
                        city: data.city || '',
                        countryId: data.countryId ? { label: data.countryId.label, value: data.countryId.value } : '',
                        ...
                        parentId: data.parentId ? { label: data.parentId.label, value: data.parentId.value } : '',
                        
                        // Non-SIF
                        employeeCode: data.employeeCode || '',
                        dateOfJoining: data.dateOfJoining ? dayjs(data.dateOfJoining, 'DD-MM-YYYY').toDate() : null,
    ...
    const checkEmployeeCode = async (val) => {
        ...
        setEmployeeCodeExist(res.data === 'Employee Code Already Exists');
         if (res.data === 'Employee Code Already Exists') {
            form.setError('employeeCode', { type: 'manual', message: 'Employee unique id already exists' });
        } else {
    ...
    const onSubmit = async (data) => {
        ...
        formData.append('gender', data.gender?.value || (typeof data.gender === 'string' ? data.gender : ''));
        formData.append('maritalStatus', data.maritalStatus?.value || (typeof data.maritalStatus === 'string' ? data.maritalStatus : ''));
                            ...
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                                                      ...
                                                      <FormField
                                                        ...
                                                        render={({ field }) => (
                                                            <FormItem>
                                                                ...
                                                                <FormControl>
                                                                    <Input {...field} disabled onBlur={(e) => { field.onBlur(); checkEmployeeCode(e.target.value); }} />
                                                                </FormControl>
                                                                <FormMessage />
                                                            </FormItem>
                                                        )}
                                                ...
                                                <div className="row mt-3">
                                                    <div className="col-md-4">
                                                        <FormField
                                                            ...
                                                            render={({ field }) => (
                                                                <FormItem>
                                                                    <FormLabel>{strings.Gender} {sifEnabled && <span className="text-danger">*</span>}</FormLabel>
                                                                    <ReactSelect
                                                    ...
                                                    <div className="col-md-4">
                                                        <FormField
                                                            ...
                                                            render={({ field }) => (
                                                                <FormItem>
                                                                    <FormLabel>{strings.maritalStatus} {sifEnabled && <span className="text-danger">*</span>}</FormLabel>
                                                                    <ReactSelect
                                                ...
                                                <div className="row mt-3">
                                                     <div className="col-md-8">
                                                            <FormField
                                                                ...
                                                                render={({ field }) => (
                                                                    <FormItem>
                                                                        <FormLabel>{strings.PresentAddress} {sifEnabled && <span className="text-danger">*</span>}</FormLabel>
                                                                        <Input {...field} />
                                                                        <FormMessage />
                                                                    </FormItem>
                                                                )}
                                                ...
                                                <div className="row mt-3">
                                                    <div className="col-md-4">
                                                            <FormField
                                                                ...
                                                                render={({ field }) => (
                                                                    <FormItem>
                                                                        <FormLabel>{strings.Country} {sifEnabled && <span className="text-danger">*</span>}</FormLabel>
                                                                        <ReactSelect
                                                    ...
                                                    <div className="col-md-4">
                                                            <FormField
                                                                ...
                                                                render={({ field }) => (
                                                                    <FormItem>
                                                                        <FormLabel>{strings.StateRegion} {sifEnabled && <span className="text-danger">*</span>}</FormLabel>
                                                                        <ReactSelect
                                                ...
                                                <div className="row">
                                                    <div className="col-md-4">
                                                         <FormField
                                                            ...
                                                            render={({ field }) => (
                                                                <FormItem>
                                                                    <FormLabel>{strings.ContactName1} {sifEnabled && <span className="text-danger">*</span>}</FormLabel>
                                                                    <Input {...field} />
                                                                    <FormMessage />
                                                                </FormItem>
                                                            )}
                                                    ...
                                                    <div className="col-md-4">
                                                         <FormField
                                                            ...
                                                            render={({ field }) => (
                                                                <FormItem>
                                                                    <FormLabel>{strings.ContactNumber1} {sifEnabled && <span className="text-danger">*</span>}</FormLabel>
                                                                    <PhoneInput
                                                                        country={'ae'}
                                                                        value={field.value}
                                                                        onChange={field.onChange}
                                                    ...
                                                    <div className="col-md-4">
                                                         <FormField
                                                            ...
                                                            render={({ field }) => (
                                                                <FormItem>
                                                                    <FormLabel>{strings.Relationship1} {sifEnabled && <span className="text-danger">*</span>}</FormLabel>
                                                                    <Input {...field} />
                                                                    <FormMessage />
                                                                </FormItem>
                                                            )}
                                ...
                                <div className="row mt-5">
                                    <div className="col-lg-12 text-right">
                                         ...
                                         <Button type="button" variant="outline" onClick={() => navigate('/admin/master/employee/viewEmployee', { state: { id: empIdFromState } })}>

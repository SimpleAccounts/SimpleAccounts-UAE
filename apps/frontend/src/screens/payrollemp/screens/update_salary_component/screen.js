...
class UpdateSalaryComponent extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      ctcTypeOption: this.props.location.state.ctcTypeOption
        ? this.props.location.state.ctcTypeOption
        : { label: 'MONTHLY', value: 2 },
      ctcType: this.props.location.state.ctcTypeOption
        ? this.props.location.state.ctcTypeOption.label
        : 'MONTHLY',
    };
  }

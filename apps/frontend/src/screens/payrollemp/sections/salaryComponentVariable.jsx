...
const SalaryComponentVariable = ({
  ...
  return (
    <div style={{ width: '250px' }}>
      <Modal isOpen={openSalaryComponentVariable} className="modal-success salary-model">
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <Input
                            ...
                            id="description"
                            placeholder={
                              strings.Enter + strings.SalaryComponent + ' ' + strings.Name
                            }
                            onChange={e => {
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <Select
                            ...
                            options={
                              type
                                ? selectOptionsFactory.renderOptions('label', 'value', type, 'Type')
                                : []
                            }
                            id="type"

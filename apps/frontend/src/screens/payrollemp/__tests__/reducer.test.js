...
describe('PayrollEmployeeReducer', () => {
  ...
  it('should maintain other state properties when updating one property', () => {
    ...
    expect(state.payroll_employee_list).toEqual(stateWithData.payroll_employee_list);
    expect(state.designation_dropdown).toEqual(stateWithData.designation_dropdown);

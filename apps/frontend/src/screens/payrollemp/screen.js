...
class PayrollEmployee extends React.Component {
  ...
  initializeData = search => {
    ...
    this.props.payrollEmployeeActions
      ...
      <div>
        ...
        >
          ...
          <DropdownMenu right>
            ...
            <DropdownItem
              onClick={() =>
                this.props.history.push('/admin/payroll/employee/salarySlip', {
                  id: row.id,
                  monthNo: 4,
                })
              }
    ...
    return (
      <label
        ...
        onClick={() => {
          ...
          // { id: row.id })
          this.props.history.push('/admin/master/employee/viewEmployee', { id: cell.data.id });
        }}
      >
        {cell.data.fullName}
      </label>
  ...
  goToDetail = row => {
    // this.props.history.push('/admin/payroll/employee/viewEmployee',
    // { id: row.id })
    this.props.history.push('/admin/master/employee/viewEmployee', { id: row.id });
  };
      ...
      .then(res => {
        if (res.status === 200) {
          ...
          if (
            ...
            payroll_employee_list.data.length > 0
          ) {
            this.setState({
              selectedRows: [],
            });
                    ...
                    <Col lg={12}>
                      ...
                      <div>
                        <BootstrapTable
                          ...
                          data={
                            payroll_employee_list && payroll_employee_list.data
                              ? payroll_employee_list.data
                              : []
                          }
                          version="4"
                          ...
                          remote
                          fetchInfo={{
                            dataTotalSize: payroll_employee_list.count

...
describe('Journal Actions', () => {
  ...
  describe('getJournalList', () => {
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getJournalList({}))).rejects.toThrow('Network error');
    });
  });
  ...
  describe('removeBulkJournal', () => {
    ...
    it('should handle bulk delete error', async () => {
      ...
      await expect(store.dispatch(actions.removeBulkJournal({ ids: [1, 2] }))).rejects.toThrow(
        'Delete failed'
      );
    });
  });
  ...
  describe('Error Handling', () => {
    it('should handle network timeout', async () => {
      ...
      await expect(store.dispatch(actions.getJournalList({}))).rejects.toThrow('Request timeout');
    });
    ...
    it('should handle 404 not found error', async () => {
      ...
      await expect(store.dispatch(actions.getInvoiceNo())).rejects.toThrow('Not found');
    });
    ...
    it('should handle 500 server error', async () => {
      ...
      await expect(store.dispatch(actions.getVatList())).rejects.toThrow('Internal server error');
    });
  });

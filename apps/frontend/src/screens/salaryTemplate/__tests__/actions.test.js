...
describe('SalaryTemplate Actions', () => {
  ...
  describe('getSalaryTemplateList', () => {
    ...
    it('should handle fetch salary template list error', async () => {
      ...
      await expect(store.dispatch(actions.getSalaryTemplateList())).rejects.toThrow(
        'Network error'
      );
    });
  ...
  describe('getSalaryStructureForDropdown', () => {
    ...
    it('should dispatch correct action on successful fetch', async () => {
      ...
      expect(dispatchedActions[0].type).toBe(SALARY_TEMPLATE.SALARY_STRUCTURE_DROPDOWN);
    });
    ...
    it('should handle fetch salary structure error', async () => {
      ...
      await expect(store.dispatch(actions.getSalaryStructureForDropdown())).rejects.toThrow(
  ...
  describe('getSalaryRolesForDropdown', () => {
    ...
    it('should handle fetch salary roles error', async () => {
      ...
      await expect(store.dispatch(actions.getSalaryRolesForDropdown())).rejects.toThrow(
        'Unauthorized access'
      );
    });
  ...
  describe('API Error Handling', () => {
    it('should handle 401 Unauthorized error', async () => {
      ...
      await expect(store.dispatch(actions.getSalaryTemplateList())).rejects.toThrow('Unauthorized');
    });

...
class CreateGoodsReceivedNote extends React.Component {
          ...
          <div>
            <div className="input-group">
              <Input
                ...
                onChange={e => {
                  if (e.target.value === '' || this.regEx.test(e.target.value)) {
                    this.selectItem(e.target.value, row, 'grnReceivedQuantity', form, field, props);
  ...
  getParentGrnDetails = parentId => {
    this.props.goodsReceivedNoteCreateAction.getGRNById(parentId).then(res => {
      if (res.status === 200) {
        ...
        this.setState(
          {
            ...
            initValue: {
              grnReceiveDate: res.data.grnReceiveDate
                ...
                : '',
              grnReceiveDate1: res.data.grnReceiveDate ? res.data.grnReceiveDate : '',
              supplierId: res.data.supplierId ? res.data.supplierId : '',
              grnNumber: res.data.grnNumber ? res.data.grnNumber : '',
            ...
            poNumber: res.data.poNumber ? res.data.poNumber : '',
            grnReceiveDateNotChanged: res.data.grnReceiveDate ? dayjs(res.data.grnReceiveDate) : '',
            grnReceiveDate: res.data.grnReceiveDate ? res.data.grnReceiveDate : '',
          ...
          () => {
            if (this.state.data.length > 0) {
              ...
              let po = selectOptionsFactory
                .renderOptions('label', 'value', this.props.po_list, 'PO Number')
  ...
  componentDidMount = () => {
    ...
    if (this.props.location.state && this.props.location.state.poId) {
      ...
      let option = {
        value: this.props.location.state.poId,
        label: this.props.location.state.poNumber,
      };
            ...
            <Select
              ...
              onChange={e => {
                if (e && e.label !== 'Select Product') {
                  ...
                  if (this.checkedRow() == false) this.addRow();
  ...
  updateAmount = (data, props) => {
    ...
    data.map(obj => {
      ...
      if (obj.discountType === 'PERCENTAGE') {
        ...
        var val1 = (+net_value - +(net_value * obj.discount) / 100) * obj.grnReceivedQuantity;
      } else if (obj.discountType === 'FIXED') {
        var val = (net_value * obj.grnReceivedQuantity - obj.discount) * (vat / 100);

        var val1 = net_value * obj.grnReceivedQuantity - obj.discount;
      } else {
  ...
  handleSubmit = (data, resetForm) => {
    ...
    formData.append('grnNumber', grn_Number !== null ? this.state.prefix + grn_Number : '');
    ...
    this.setState({
      ...
      loadingMsg: 'Creating Goods Received Note...',
    });
  ...
  getCurrentProduct = () => {
    this.props.goodsReceivedNoteAction.getProductList().then(res => {
      ...
      this.formRef.current.setFieldValue(`lineItemsString.${0}.grnReceivedQuantity`, 1, true);
      // this.formRef.current.setFieldValue(
  ...
  validationCheck = value => {
    ...
    this.props.goodsReceivedNoteCreateAction.checkValidation(data).then(response => {
  ...
  getPoDetails = (e, row, props, form, field) => {
    ...
    if (e && e.label !== 'Select RFQ') {
      this.poValue(e.value, row, 'poNumber', form, field, props);
      this.props.purchaseOrderDetailsAction.getPOById(e.value).then(response => {
        this.setState(
          {
            option: {
                          ...
                          <Formik
                            ...
                            validate={values => {
                              ...
                              if (this.state.exist === true) {
                                errors.grn_Number = 'GRN number already axists';
                              }
                            ...
                            validationSchema={Yup.object().shape({
                              grn_Number: Yup.string().required('Invoice number is required'),
                              supplierId: Yup.string().required('Supplier is required'),
                              // placeOfSupplyId: Yup.string().required('Place of supply is required'),

                              grnReceiveDate: Yup.string().required('Order date is required'),
                              rfqExpiryDate: Yup.string().required('Order due date is required'),
                            ...
                            {props => (
                              <Form onSubmit={props.handleSubmit}>
                                    ...
                                    <FormGroup className="mb-3">
                                      ...
                                      <Select
                                        isDisabled={
                                          ...
                                          this.props.location.state.poId
                                            ? true
                                            : false
                                        }
                                        styles={customStyles}
                                        ...
                                        value={
                                          ...
                                          this.props.location.state.poId
                                            ? selectOptionsFactory
                                                ...
                                                .find(
                                                  option =>
                                                    option.value == this.props.location.state.poId
                                                )
                                        ...
                                        // }}
                                        className={
                                          props.errors.poNumber && props.touched.poNumber
                                            ? 'is-invalid'
                                            : ''
                                        }
                                      />
                                      ...
                                      <Input
                                        ...
                                        onChange={option => {
                                          if (
                                            ...
                                            props.handleChange('grn_Number')(option);
                                          }
                                          this.validationCheck(option.target.value);
                                        }}
                                        className={
                                          props.errors.grn_Number && props.touched.grn_Number
                                            ? 'is-invalid'
                                            : ''
                                        }
                                      />
                                ...
                                <Row>
                                  <Col lg={3}>
                                    <FormGroup className="mb-3">
                                      ...
                                      <Select
                                        ...
                                        className={
                                          props.errors.supplierId && props.touched.supplierId
                                            ? 'is-invalid'
                                            : ''
                                        }
                                      />
                                  ...
                                  {this.props.location.state && this.props.location.state.poId ? (
                                    ''
                                  ) : (
                                    <Col lg={3}>
                                  ...
                                  <Col lg={3}>
                                    <FormGroup className="mb-3">
                                      ...
                                      {props.errors.grnReceiveDate &&
                                        props.touched.grnReceiveDate && (
                                          <div className="invalid-feedback">
                                            {props.errors.grnReceiveDate.includes('nullable()')
                                    ...
                                    <Col lg={3}>
                                      <FormGroup className="mb-3">
                                        ...
                                        <Input
                                          ...
                                          onChange={value => {
                                            props.handleChange('supplierReferenceNumber')(value);
                                          }}
                                          className={
                                      ...
                                      <Row>
                                        <Col lg={6}>
                                          <FormGroup className="mb-3">
                                            ...
                                            />
                                            {props.errors.grnRemarks &&
                                              props.touched.grnRemarks && (
                                                <div className="invalid-feedback">
                                                  {props.errors.grnRemarks}
                                                </div>
                                              )}

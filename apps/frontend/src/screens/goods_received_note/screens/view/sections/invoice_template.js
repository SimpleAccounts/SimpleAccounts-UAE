...
class RFQTemplate extends Component {
  ...
  getVatNo = (contactData, RFQData) => {
    if (
      contactData.taxTreatmentId != 2 &&
      contactData.taxTreatmentId != 4 &&
      contactData.taxTreatmentId != 6 &&
      contactData.taxTreatmentId != 7
    )
      return (
        <div className="mb-1 ml-2">
          {strings.VATRegistrationNo}: {RFQData.vatRegistrationNumber}
        </div>
      );
    else return '';
  };
            ...
            >
              ...
              >
                ...
                <div style={{ width: '27%' }}>
                  <br />
                  <div className="mb-1 ml-2">
                    <b>{strings.GRNNo}: </b> # {RFQData.grnNumber}
                  </div>
                  <div className="mb-1 ml-2">
                    <b>{strings.ReceiveDate}: </b>{' '}
                    {dayjs(RFQData.grnReceiveDate).format('DD MMM YYYY')}
                  </div>
                  <div className="mb-1 ml-2">
                    <b>{strings.Status}: </b>
            ...
            <Table className="table-striped">
              <thead className="header-row" style={{ fontSize: '12px' }}>
                <tr>
                  ...
                  <th style={{ padding: '0.5rem', textAlign: 'center' }}>{strings.Quantity}</th>

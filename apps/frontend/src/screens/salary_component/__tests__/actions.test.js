...
describe('Salary Component Actions', () => {
  ...
  describe('saveSalaryComponent', () => {
    it('should save new salary component successfully', async () => {
      ...
      const result = await store.dispatch(actions.saveSalaryComponent(mockComponent, false));
    ...
    it('should update existing salary component when isCreated is true', async () => {
      ...
      const result = await store.dispatch(actions.saveSalaryComponent(mockComponent, true));
    ...
    it('should handle save error', async () => {
      ...
      await expect(store.dispatch(actions.saveSalaryComponent({}, false))).rejects.toThrow(
        'Save failed'
      );
    });
  ...
  describe('updateSalaryComponent', () => {
    it('should update salary component successfully', async () => {
      ...
      const result = await store.dispatch(actions.updateSalaryComponent(mockComponent));
    ...
    it('should handle update error', async () => {
      ...
      await expect(store.dispatch(actions.updateSalaryComponent({}))).rejects.toThrow(
        'Update failed'
      );
    });
  ...
  describe('deleteSalaryComponent', () => {
    ...
    it('should handle delete error', async () => {
      ...
      await expect(store.dispatch(actions.deleteSalaryComponent(1))).rejects.toThrow(
        'Delete failed'
      );
    });
    ...
    it('should handle validation errors', async () => {
      authApi.mockRejectedValue(new Error('Cannot delete component in use'));

      await expect(store.dispatch(actions.deleteSalaryComponent(1))).rejects.toThrow(
        'Cannot delete component in use'
      );
    });
  });
  ...
  describe('getSalaryComponentById', () => {
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getSalaryComponentById(999))).rejects.toThrow(
        'Component not found'
      );
    });
    ...
    it('should handle unauthorized access', async () => {
      ...
      await expect(store.dispatch(actions.getSalaryComponentById(1))).rejects.toThrow(
        'Unauthorized'
      );
    });
  });

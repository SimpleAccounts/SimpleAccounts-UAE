              ...
              >
                <div>
                  ...
                  <h6 className="mb-1 ml-2">
                    <b>{strings.Quotation_For}</b>
                  </h6>
                  <br />
                  <div className="mb-1 ml-2">
                    <b>
                      {QuotationData.organisationName
                        ? QuotationData.organisationName
                  ...
                  {QuotationData &&
                    QuotationData.taxtreatment &&
                    QuotationData.taxtreatment.includes('NON') == false && (
                      <div className="mb-1 ml-2">
                        {strings.VATRegistrationNo}: {QuotationData.vatRegistrationNumber}
                      </div>
                    )}
                ...
                <div style={{ width: '27%' }}>
                  <br />
                  <div className="mb-1 ml-2">
                    <b>{strings.QuotationNo}:</b> {QuotationData.quotationNumber}
                  </div>
                  {QuotationData.receiptNumber && (
                    <div className="mb-1 ml-2">
                  ...
                  <div className="mb-1 ml-2">
                    ...
                    {dayjs(QuotationData.quotationdate).format('DD-MM-YYYY')}
                  </div>
                  <div className="mb-1 ml-2">
                    <b>{strings.ExpirationDate}: </b>
                    {dayjs(QuotationData.quotaionExpiration).format('DD-MM-YYYY')}
                  </div>
                  <div className=" ml-2">
                    <b>{strings.Status}: </b>
                    {this.renderQuotationStatus(QuotationData.status)}
                  </div>
              ...
              <thead className="header-row" style={{ fontSize: '12px' }}>
                <tr>
                  ...
                  <th style={{ padding: '0.5rem', textAlign: 'right' }}>
                    {QuotationData.discount && QuotationData.discount > 0 ? strings.Discount : ''}
                  </th>
                  ...
                  <th style={{ padding: '0.5rem', textAlign: 'right' }}>
                    ...
                    QuotationData.totalVatAmount > 0
                      ? strings.VatAmount
                      : ''}
                  </th>
                      ...
                      {QuotationData.totalExciseAmount && QuotationData.totalExciseAmount > 0 ? (
                        <tr>
                          ...
                          >
                            ...
                            <span>
                              {QuotationData.totalExciseAmount
                                ? QuotationData.currencyIsoCode +
                                  ' ' +
                                  QuotationData.totalExciseAmount.toLocaleString(
                                    navigator.language,
                                    { minimumFractionDigits: 2 }
                                  )
                                : QuotationData.currencyIsoCode +
                          ...
                          >
                            ...
                            <span>
                              {QuotationData.discount
                                ? QuotationData.currencyIsoCode +
                                  ' ' +
                                  QuotationData.discount.toLocaleString(navigator.language, {
                                    minimumFractionDigits: 2,
                                  })
                                : QuotationData.currencyIsoCode +
                                  ' ' +
                          ...
                          <span>
                            {QuotationData.totalAmount
                              ? QuotationData.currencyIsoCode +
                                ' ' +
                                (
                                  parseFloat(QuotationData.totalAmount) -
                                  parseFloat(QuotationData.totalVatAmount) -
                                  parseFloat(QuotationData.totalExciseAmount)
                          ...
                          >
                            ...
                            <span>
                              {QuotationData.totalVatAmount
                                ? QuotationData.currencyIsoCode +
                                  ' ' +
                                  QuotationData.totalVatAmount.toLocaleString(navigator.language, {
                                    minimumFractionDigits: 2,
                                  })
                                : QuotationData.currencyIsoCode +
                                  ' ' +
                        ...
                        >
                          ...
                          <span>
                            {QuotationData.totalAmount
                              ? QuotationData.currencyIsoCode +
                                ' ' +
                                QuotationData.totalAmount.toLocaleString(navigator.language, {
                                  minimumFractionDigits: 2,
                                })
                              : 0}
                            {/* {POData.totalAmount ? (

...
class CreateReceipt extends React.Component {
  ...
  onRowSelect = (row, isSelected, e) => {
    ...
    this.setState(
      ...
      () => {
        this.formRef.current.setFieldValue('paidInvoiceListStr', tempList, true);
  ...
  handleSubmit = (data, resetForm) => {
    ...
    formData.append('paidInvoiceListStr', JSON.stringify(this.state.paidInvoiceListStr));
                    ...
                    <Col lg={12}>
                      <Formik
                        ...
                        validationSchema={Yup.object().shape({
                          receiptDate: Yup.date().nullable().required('Receipt date is required'),
                          contactId: Yup.string().nullable().required('Customer is required'),
                          depositeTo: Yup.string().nullable().required('Deposit to is required'),
                          payMode: Yup.string().nullable().required('Payment mode is required'),
                          paidInvoiceListStr: Yup.string()
                            .nullable()
                            .required('Please select atleast one invoice'),
                          amount: Yup.string()
                            .nullable()
                                  ...
                                  <div>
                                              ...
                                              <Input
                                                ...
                                                onChange={option => {
                                                  if (
                                                    ...
                                                    props.handleChange('referenceCode')(option);
                                                  }
                                                }}
                                    ...
                                    <Row>
                                      ...
                                      >
                                        ...
                                        <TableHeaderColumn
                                          dataField="date"
                                          dataFormat={(cell, rows) => this.date(cell, rows, props)}
                                        >
                                          {strings.Date}
                                        </TableHeaderColumn>

...
describe('Receipt Actions', () => {
  ...
  describe('getReceiptList', () => {
    ...
    it('should format date correctly when provided', async () => {
      ...
      const expectedDateFormat = dayjs(dateToTest).format('DD-MM-YYYY');
      expect(authApi).toHaveBeenCalledWith(
        expect.objectContaining({
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getReceiptList({}))).rejects.toThrow('Network error');
    });
  ...
  describe('Error Handling', () => {
    it('should handle network timeout', async () => {
      ...
      await expect(store.dispatch(actions.getReceiptList({}))).rejects.toThrow('Request timeout');
    });
    ...
    it('should handle 401 unauthorized error', async () => {
      ...
      await expect(store.dispatch(actions.getContactList(2))).rejects.toThrow('Unauthorized');
    });
    ...
    it('should handle 404 not found error', async () => {
      ...
      await expect(store.dispatch(actions.getInvoiceList())).rejects.toThrow('Not found');
    });
    ...
    it('should handle 500 server error', async () => {
      ...
      await expect(store.dispatch(actions.removeBulk({ ids: [1] }))).rejects.toThrow(

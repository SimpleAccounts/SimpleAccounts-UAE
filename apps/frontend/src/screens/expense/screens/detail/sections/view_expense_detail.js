            ...
            <Col lg={12}>
              <div>
                <Row>
                  ...
                  <Col lg={4}>
                    <FormGroup className="mb-3">
                      ...
                      <p>
                        {' '}
                        {initialVals.expenseDate
                          ? dayjs(initialVals.expenseDate).format('DD/MM/YYYY')
                          : '-'}
                      </p>
                    </FormGroup>
                  </Col>
                ...
                <Row>
                  <Col lg={4}>
                    <FormGroup className="mb-3">
                      ...
                      <p>
                        {initialVals.expenseAmount
                          ? initialVals.expenseAmount.toLocaleString(navigator.language, {
                ...
                <Row>
                  <Col lg={4}>
                    <FormGroup className="mb-3">
                      <Label className="label" htmlFor="iban_number">
                        Reciept Number
                      </Label>
                  ...
                  <Col lg={4}>
                    <FormGroup className="mb-3">
                      ...
                      {initialVals.fileName ? (
                        <NavLink
                          download={initialVals.fileName}
                          href={`${API_ROOT_URL.API_ROOT_URL}${initialVals.filePath}`}
                  ...
                  <Col lg={4}>
                    <FormGroup className="mb-3">
                      <Label className="label" htmlFor="swift_code">
                        Attachment Description
                      </Label>
                      <p>
                        {initialVals.attachementDescription
                          ? initialVals.attachementDescription
                          : '-'}
                      </p>
                    </FormGroup>

          ...
          onClick={() => {
            if (row.supplierId !== null && row.productId !== null) {
              this.props.productActions
                .getInventoryHistory({ p_id: row.productId, s_id: row.supplierId })
                .then(res => {
                  if (res.status === 200) {
                    this.setState({
          ...
          <Button
            ...
            onClick={() => {
              if (params.data.supplierId !== null && params.data.productId !== null) {
                this.props.productActions
                  .getInventoryHistory({
                    p_id: params.data.productId,
                    s_id: params.data.supplierId,
                  })
                  .then(res => {
                    if (res.status === 200) {
                      this.setState({
              ...
              {loading ? (
                ...
                <div>
                  <BootstrapTable
                    ...
                    data={summary_list && summary_list.data ? summary_list.data : []}
                    version="4"
                    hover
                    pagination={
                      summary_list && summary_list.data && summary_list.data.length > 0
                        ? true
                        : false
                    }
                    remote
                    fetchInfo={{
                      dataTotalSize: summary_list.count ? summary_list.count : 0,
                    }}
                  ...
                  >
                    ...
                    <TableHeaderColumn
                      ...
                      dataSort
                      className="text-center table-header-bg"

...
class InventoryDashboard extends React.Component {
  ...
  handleChange = (val, val1, name, reconcile, row, label) => {
    ...
    switch (val.value) {
      case 'Monthly':
        tempTopSelling.labels = Object.keys(
          this.state.topSellingProducts.topSellingProductsMonthly
        );
        tempTopSelling.datasets[0].data = Object.values(
          this.state.topSellingProducts.topSellingProductsMonthly
        );
      ...
      case 'Quaterly':
        tempTopSelling.labels = Object.keys(
          this.state.topSellingProducts.topSellingProductsQuarterly
        );
        tempTopSelling.datasets[0].data = Object.values(
          this.state.topSellingProducts.topSellingProductsQuarterly
        );
      ...
      case 'Biannually':
        tempTopSelling.labels = Object.keys(
          this.state.topSellingProducts.topSellingProductsSixMonthly
        );
        tempTopSelling.datasets[0].data = Object.values(
          this.state.topSellingProducts.topSellingProductsSixMonthly
        );
      ...
      case 'Yearly':
        ...
        tempTopSelling.datasets[0].data = Object.values(
          this.state.topSellingProducts.topSellingProductsYearly
        );
        this.setState({ dataHorBar: tempTopSelling });
        break;
    }
  ...
  handleChange1 = (val, val1, name, reconcile, row, label) => {
    ...
    switch (val.value) {
      case 'Monthly':
        tempLowSelling.labels = Object.keys(
          this.state.lowSellingProducts.lowSellingProductsMonthly
        );
        tempLowSelling.datasets[0].data = Object.values(
          this.state.lowSellingProducts.lowSellingProductsMonthly
        );
      ...
      case 'Quaterly':
        tempLowSelling.labels = Object.keys(
          this.state.lowSellingProducts.lowSellingProductsQuarterly
        );
        tempLowSelling.datasets[0].data = Object.values(
          this.state.lowSellingProducts.lowSellingProductsQuarterly
        );
      ...
      case 'Biannually':
        tempLowSelling.labels = Object.keys(
          this.state.lowSellingProducts.lowSellingProductsSixMonthly
        );
        tempLowSelling.datasets[0].data = Object.values(
          this.state.lowSellingProducts.lowSellingProductsSixMonthly
        );
      ...
      case 'Yearly':
        ...
        tempLowSelling.datasets[0].data = Object.values(
          this.state.lowSellingProducts.lowSellingProductsYearly
        );
        this.setState({ dataHorBarLeft: tempLowSelling });
        break;
    }
  ...
  handleChange2 = (val, val1, name, reconcile, row, label) => {
    ...
    switch (val.value) {
      ...
      case 'Biannually':
        ...
        tempRevenue.datasets[0].data = Object.values(
          this.state.totalRevenue.totalRevenueSixMonthly
        );
        this.setState({ dataLine: tempRevenue });
        break;
      case 'Yearly':
  ...
  handleChange3 = (val, val1, name, reconcile, row, label) => {
    ...
    switch (val.value) {
      case 'Monthly':
        ...
        tempProfit.datasets[0].data = Object.values(
          this.state.topProfitGeneratingProducts.totalProfitMonthly
        );
        this.setState({ databar: tempProfit });
        console.log(tempProfit.labels);
        break;
      case 'Quaterly':
        tempProfit.labels = Object.keys(
          this.state.topProfitGeneratingProducts.totalProfitQuarterly
        );
        tempProfit.datasets[0].data = Object.values(
          this.state.topProfitGeneratingProducts.totalProfitQuarterly
        );
      ...
      case 'Biannually':
        tempProfit.labels = Object.keys(
          this.state.topProfitGeneratingProducts.totalProfitSixMonthly
        );
        tempProfit.datasets[0].data = Object.values(
          this.state.topProfitGeneratingProducts.totalProfitSixMonthly
        );
      ...
      case 'Yearly':
        ...
        tempProfit.datasets[0].data = Object.values(
          this.state.topProfitGeneratingProducts.totalProfitYearly
        );
        this.setState({ databar: tempProfit });
        break;
    }
          ...
          <div style={{ marginLeft: 'auto', marginRight: 'auto' }}>
            <Row>
              ...
              >
                ...
                <h3 className="d-block mt-4 text-center">{this.state.allProducts}</h3>
              </CardBody>
              <CardBody
                className="mr-3  mb-3"
                style={{
              ...
              >
                ...
                <h3 className="d-block mt-4 text-center">{this.state.quantityAvailable}</h3>
              </CardBody>
              <CardBody
                className=" mb-3 "
                style={{
              ...
              >
                ...
                <h3 className="d-block mt-4 text-center">{this.state.outOfStock}</h3>
              </CardBody>
            </Row>
          </div>
          ...
          <Row>
            ...
            >
              ...
              >
                ...
                <CardBody>
                  <div>
                    <Bar data={dataHorBar} options={dataHorBarOption} />
                  </div>
                </CardBody>
              </Card>
              ...
              >
                ...
                <CardBody>
                  <div>
                    <Bar data={dataHorBarLeft} options={dataHorBarLeftOption} />
                  </div>
                </CardBody>
              </Card>
            </CardGroup>
          ...
          <Row className={'mt-2'}>
            ...
            >
              ...
              <Card style={{}}>
                ...
                <CardBody>
                  <div>
                    <Bar data={databar} options={databarOption} style={{ height: '200px' }} />
                  </div>
                </CardBody>
              </Card>
            </CardGroup>

...
class ViewCustomerInvoice extends React.Component {
  ...
  initializeData = () => {
    ...
    if (this.props.location.state && this.props.location.state.id) {
      this.props.supplierInvoiceDetailActions
        ...
        .then(res => {
          ...
          if (!this.props.location.state.contactId)
            this.props.supplierInvoiceDetailActions.getContactById(res.data.contactId).then(res => {
              if (res.status === 200) {
                this.setState({
          ...
          const invoiceStatus = res.data.status
                  ...
                  this.props.supplierInvoiceActions.getCurrencyList().then(res => {
                    if (res.status === 200) {
                      const temp = res.data.filter(
                        item => item.currencyCode === this.state.invoiceData.currencyCode
                      );
                      this.setState({
                        currencyData: temp,
                      });
      ...
      this.props.commonActions.getByNoteListByInvoiceId(this.props.location.state.id).then(res => {
        if (res.status === 200) {
          this.setState({
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    if (
                      ...
                      this.props.location.state &&
                      this.props.location.state.crossLinked &&
                      ...
                      this.props.location &&
                      this.props.location.state &&
                      this.props.location.state.gotoDGLReport
                    )

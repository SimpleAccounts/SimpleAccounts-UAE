...
describe('CustomerInvoice Actions', () => {
  ...
  describe('getCustomerInvoiceList', () => {
    ...
    it('should not dispatch when paginationDisable is true', async () => {
      ...
      await store.dispatch(actions.getCustomerInvoiceList({ paginationDisable: true }));
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getCustomerInvoiceList({}))).rejects.toThrow(
        'Network error'
      );
    });
  });
  ...
  describe('createCustomer', () => {
    it('should create customer successfully', async () => {
      ...
      const result = await store.dispatch(actions.createCustomer(mockCustomerData));
  ...
  describe('getOverdueAmountDetails', () => {
    it('should fetch overdue amount details successfully', async () => {
      ...
      const result = await store.dispatch(actions.getOverdueAmountDetails(invoiceType));

					...
					return (
						...
						>
							...
							<DropdownMenu right>
								...
								<DropdownItem
									onClick={() =>
										this.props.history.push('/admin/income/customer-invoice/create', { parentInvoiceId: rowData.id })
									}
								>
									<i className="fas fa-copy" /> {strings.CreateADuplicate}
								</DropdownItem>
								{(!rowData.cnCreatedOnPaidInvoice && rowData.statusEnum === 'Paid' && rowData.remainingInvoiceAmount !== true && config.INCOME_TCN) && (
									<DropdownItem
										onClick={() => {
								...
								<DropdownItem
									onClick={() =>
										this.props.history.push('/admin/income/customer-invoice/view', {
											id: rowData.id, status: rowData.status, contactId: rowData.contactId
										})
									}
								>

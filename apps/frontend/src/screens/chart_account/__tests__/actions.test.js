...
describe('Chart Account Actions', () => {
  ...
  describe('getSubTransactionTypes', () => {
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getSubTransactionTypes())).rejects.toThrow(
        'Failed to fetch sub transaction types'
      );
    });
  ...
  describe('getTransactionTypes', () => {
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getTransactionTypes())).rejects.toThrow('Network error');
    });
  ...
  describe('getTransactionCategoryList', () => {
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getTransactionCategoryList({}))).rejects.toThrow(
  ...
  describe('getTransactionCategoryExportList', () => {
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getTransactionCategoryExportList({}))).rejects.toThrow(
        'Export failed'
      );
    });
  });
  ...
  describe('getExplainedTransactionCountForTransactionCategory', () => {
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(
        store.dispatch(actions.getExplainedTransactionCountForTransactionCategory(123))
    ...
    it('should not dispatch any actions', async () => {
      ...
      await store.dispatch(actions.getExplainedTransactionCountForTransactionCategory(1));

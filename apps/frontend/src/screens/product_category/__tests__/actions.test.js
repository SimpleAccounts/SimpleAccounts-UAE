...
describe('Product Category Actions', () => {
  ...
  describe('getProductCategoryList', () => {
    ...
    it('should handle API errors gracefully', async () => {
      ...
      await expect(store.dispatch(actions.getProductCategoryList(postObj))).rejects.toThrow(
  ...
  describe('deleteProductCategory', () => {
    ...
    it('should handle deletion errors', async () => {
      ...
      await expect(store.dispatch(actions.deleteProductCategory(deleteData))).rejects.toThrow(
        'Deletion failed'
      );
    });
  ...
  describe('Action error handling', () => {
    it('should propagate API errors correctly for getProductCategoryList', async () => {
      ...
      await expect(actions.getProductCategoryList({ pageNo: 1 })(dispatch)).rejects.toThrow(
        'API Error'
      );
    });
    ...
    it('should propagate API errors correctly for deleteProductCategory', async () => {
      ...
      await expect(actions.deleteProductCategory({ ids: [1] })(dispatch)).rejects.toThrow(
        'Delete API Error'
      );
    });
    ...
    it('should handle network errors', async () => {
      ...
      await expect(actions.getProductCategoryList({ pageNo: 1 })(jest.fn())).rejects.toThrow();
      await expect(actions.deleteProductCategory({ ids: [1] })(jest.fn())).rejects.toThrow();
    });
  });
});

									...
									<Controller
										...
										render={({ field }) => (
											<PhoneInput
												...
												containerClass={errors.mobileNumber || mobileNumberError ? 'is-invalid' : ''}
											/>
										)}
									/>
							...
							<Col md="4">
								<FormGroup>
									...
									<div className="VerifyTRN">
										<br />
										<b>
											<a target="_blank" href="https://tax.gov.ae/en/default.aspx" style={{ color: '#2266d8' }}>
												{strings.VerifyTRN}
											</a>
										</b>
									</div>
									...
									<Col md="4">
										<FormGroup>
											<Label htmlFor="addressLine1">
												<span className="text-danger">* </span>{strings.AddressLine1}
											</Label>
											<Controller
												name="addressLine1"
												control={control}
									...
									<Col md="4">
										<FormGroup>
											<Label htmlFor="addressLine2">
												<span className="text-danger">* </span>{strings.AddressLine2}
											</Label>
											<Controller
												name="addressLine2"
												control={control}
									...
									<Col md="4">
										<FormGroup>
											<Label htmlFor="addressLine3">
												<span className="text-danger">* </span>{strings.AddressLine3}
											</Label>
											<Controller
												name="addressLine3"
												control={control}

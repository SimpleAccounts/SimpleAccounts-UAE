...
describe('UsersRoles Actions', () => {
  ...
  describe('getRoleList', () => {
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getRoleList({}))).rejects.toThrow('Network error');
    });
    ...
    it('should handle sorting by specific column', async () => {
      ...
      await store.dispatch(actions.getRoleList({ sortingCol: 'createdDate' }));
  ...
  describe('getModuleList', () => {
    ...
    it('should handle fetch error for module list', async () => {
      ...
      await expect(store.dispatch(actions.getModuleList('ADMIN'))).rejects.toThrow(
  ...
  describe('getUsersCountForRole', () => {
    ...
    it('should handle fetch error for users count', async () => {
      ...
      await expect(store.dispatch(actions.getUsersCountForRole(1))).rejects.toThrow(
  ...
  describe('deleteRole', () => {
    ...
    it('should handle delete error', async () => {
      ...
      await expect(store.dispatch(actions.deleteRole('ADMIN'))).rejects.toThrow(
        'Cannot delete role'
      );
    });
  ...
  describe('API Error Handling', () => {
    it('should handle 401 Unauthorized error', async () => {
      ...
      await expect(store.dispatch(actions.getRoleList({}))).rejects.toThrow('Unauthorized');
    });
    ...
    it('should handle 403 Forbidden error', async () => {
      ...
      await expect(store.dispatch(actions.deleteRole('ADMIN'))).rejects.toThrow('Forbidden');
    });
    ...
    it('should handle 404 Not Found error', async () => {
      ...
      await expect(store.dispatch(actions.getModuleList('NONEXISTENT'))).rejects.toThrow(
        'Role not found'
      );
    });

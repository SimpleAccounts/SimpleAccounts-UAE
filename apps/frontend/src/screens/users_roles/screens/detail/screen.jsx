...
import { Users, Trash2, CircleDot, Ban } from 'lucide-react';
...
const UpdateRole = ({ commonActions, RoleActions, RoleCommonActions, history, location }) => {
  ...
  const getvalidation = () => {
    let msg = validationForSelect !== 0 ? '' : 'Please select atleast 1 module';
  ...
  const deleteRole = () => {
    ...
    const message = 'This Role will be deleted permanently and cannot be recovered. ';
    setDialog(
      <ConfirmDeleteModal
        isOpen={true}

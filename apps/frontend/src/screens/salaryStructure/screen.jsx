...
const SalaryStructure = () => {
    ...
    const goToDetail = (row) => {
        navigate('/admin/payroll/config/detailSalaryStructure', { state: { id: row.salaryStructureId } });
    };
                                ...
                                <Col lg={12}>
                                    ...
                                    <div>
                                        <DataTable
                                            ...
                                            pageCount={salaryStructure_list?.count ? Math.ceil(salaryStructure_list.count / pagination.pageSize) : 0}

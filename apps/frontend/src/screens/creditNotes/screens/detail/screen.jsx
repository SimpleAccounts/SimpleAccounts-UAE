      ...
      creditNotesDetailActions
        ...
        .then((res) => {
          if (res.status === 200) {
            ...
            creditNotesActions
              .getCustomerList(contactType)
              .then((response) => {
                if (response.status === 200)
                  getCurrency(res.data.contactId);
              });
            ...
            setIsCreatedWIWP(
              res.data.invoiceLineItems && res.data.invoiceLineItems?.length > 0
                ? false
                : true
            );
            ...
            if (res.data.invoiceId) {
              creditNotesDetailActions
                ...
                .then((response) => {
                  ...
                  setValue("taxTreatmentid", getTaxTreatment(customerdetails.value), { shouldValidate: true });
  ...
  const removeInvoice = () => {
    ...
    creditNotesDetailActions
      ...
      .catch((err) => {
        commonActions.tostifyAlert(
          "error",
          "Tax Credit Note Deleted Unsuccessfully"
        );
      });
  };
                    ...
                    <Row>
                      <Col lg={12}>
                        <Form onSubmit={handleSubmit(onSubmit)}>
                          ...
                          <hr />
                          {!isCreatedWIWP &&
                            getValues().lineItemsString?.length > 0 && (
                              <>
                                <Row>

                                ...
                                <Col lg={12}>
                                        ...
                                        <form onSubmit={(e) => e.preventDefault()}>
                                            <Row>
                                                <Col lg={2} className="mb-1">
                                                    <Input type="text" placeholder="Project Name" value={filterData.projectName} onChange={(e) => handleFilterChange(e.target.value, 'projectName')} />
                                                </Col>
                                                <Col lg={2} className="mb-1">
                                                    <Input type="text" placeholder="Expense Budget" value={filterData.expenseBudget} onChange={(e) => handleFilterChange(e.target.value, 'expenseBudget')} />
                                                </Col>
                                                <Col lg={2} className="mb-1">
                                                    <Input type="text" placeholder="Revenue Budget" value={filterData.revenueBudget} onChange={(e) => handleFilterChange(e.target.value, 'revenueBudget')} />
                                                </Col>
                                                <Col lg={2} className="mb-1">
                                                    <Input type="text" placeholder="VAT Number" value={filterData.vatRegistrationNumber} onChange={(e) => handleFilterChange(e.target.value, 'vatRegistrationNumber')} />
                                                </Col>
                                    ...
                                    <div>
                                        <DataTable
                                            ...
                                            pageCount={project_list?.count ? Math.ceil(project_list.count / pagination.pageSize) : 0}

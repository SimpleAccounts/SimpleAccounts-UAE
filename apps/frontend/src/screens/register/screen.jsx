...
const registerSchema = z
  .object({
    ...
    countryId: z
      .union([z.string(), z.number(), z.object({ value: z.union([z.string(), z.number()]) })])
      .refine(val => {
...
const Register = ({
  ...
  const handleSubmit = async data => {
    ...
    authActions.registerStrapiUser(strapiUserObj, companyStrapiObj).catch(strapiErr => {
                        ...
                        <CardBody>
                          ...
                          <Form onSubmit={form.handleSubmit(handleSubmit)}>
                                  ...
                                  <Select
                                    ...
                                    value={
                                      ...
                                      selectCurrencyFactory
                                        ...
                                        .find(
                                          option => option.value === +form.watch('currencyCode')
                                        )
                                    }
                                    onChange={option => {
                                      if (option && option.value) {
                                    ...
                                    className={
                                      form.formState.errors.currencyCode ? 'is-invalid' : ''
                                    }
                                  />
                              ...
                              <Col lg={4}>
                                <FormGroup>
                                  ...
                                  <Select
                                    ...
                                    value={
                                      company_type_list &&
                                      company_type_list.find(option => {
                                        const watchedValue = form.watch('companyTypeCode');
                                        return (
                                          option.value === +watchedValue ||
                                          String(option.value) === String(watchedValue)
                                        );
                                      })
                                    }
                                    onChange={option => {
                                      if (option && option.value) {
                                        form.setValue('companyTypeCode', String(option.value), {
                                          shouldValidate: true,
                                          shouldTouch: true,
                                        });
                                      } else {
                                    ...
                                    className={
                                      form.formState.errors.companyTypeCode ? 'is-invalid' : ''
                                    }
                                  />
                            ...
                            <Row className="row-wrapper">
                              ...
                              <Col lg={4}>
                                <FormGroup className="mb-3">
                                  <Label htmlFor="timeZone">{strings.TimeZonePreference}</Label>
                                  <Select
                                    isDisabled
                                    styles={customStyles}
                                    id="timeZone"
                                    ...
                                    value={
                                      timezone && form.watch('timeZone')
                                        ? timezone.find(
                                            option => option.value === form.watch('timeZone')
                                          )
                                        : null
                                    }
                                    onChange={option => {
                                    ...
                                    className={form.formState.errors.timeZone ? 'is-invalid' : ''}
                                  />
                                  ...
                                  <Select
                                    ...
                                    value={
                                      ...
                                      selectOptionsFactory
                                        ...
                                        .find(option => option.value === +form.watch('countryId'))
                                    }
                                    onChange={handleCountryChange}
                                    id="countryId"
                                    name="countryId"
                                    className={form.formState.errors.countryId ? 'is-invalid' : ''}
                                  />
                              ...
                              <Col lg={4}>
                                <FormGroup>
                                  ...
                                  <Select
                                    ...
                                    value={
                                      state_list &&
                                      state_list.find(option => {
                                        const stateIdValue = form.watch('stateId');
                                        if (
                                          typeof stateIdValue === 'object' &&
                                          stateIdValue !== null
                                        ) {
                                    ...
                                    className={form.formState.errors.stateId ? 'is-invalid' : ''}
                                  />
                                    ...
                                    <PhoneInput
                                      ...
                                      isValid={(value, country) => {
                                        ...
                                        if (country && country.dialCode === '971') {
                                          ...
                                          return (
                                            localNumber.length === 9 && /^[0-9]+$/.test(localNumber)
                                          );
                                        }
                            ...
                            <Row className="mb-4">
                              <Col lg={5}>
                                <FormGroup check inline className="mt-1">
                                  <Label className="form-check-label mt-3" check htmlFor="vat">
                                    <Input
                                      type="checkbox"
                                      id="IsRegistered"
                                      name="IsRegistered"
                                      ...
                                      className={
                                        form.formState.errors.IsRegistered ? 'is-invalid' : ''
                                      }
                                    />
                                    Is VAT Registered?
                            ...
                            <Row
                              ...
                              style={{ display: form.watch('IsRegistered') === true ? '' : 'none' }}
                            >
                              <Col lg={4}>
                                <FormGroup>
                                  <Label htmlFor="TaxRegistrationNumber">
                                    ...
                                    <div className="tooltip-icon nav-icon fas fa-question-circle ml-1">
                                      <span className="tooltiptext">
                                        Please note that the TRN cannot be updated <br></br>once a
                              ...
                              <Col lg={4}>
                                <FormGroup>
                                  <Label htmlFor="vatRegistrationDate">
                                    ...
                                    <div className="tooltip-icon nav-icon fas fa-question-circle ml-1">
                                      <span className="tooltiptext">
                                        Please note that you cannot update <br></br> this detail
                                        once you have created a document.
                                      </span>
                                    </div>
                                  </Label>
                                  <DatePicker
                                    ...
                                    className={`form-control ${
                                      form.formState.errors.vatRegistrationDate ? 'is-invalid' : ''
                                    }`}
                                  />
                            ...
                            <Row>
                              <Col className="text-center">
                                <Button
                                  ...
                                  title={
                                    !form.formState.isValid
                                      ? `Please fill all required fields. Errors: ${Object.keys(form.formState.errors).length}`
                                      : ''
                                  }
                                >

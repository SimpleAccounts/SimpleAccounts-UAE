...
describe('Salary Roles Actions', () => {
  ...
  describe('getSalaryRoleList', () => {
    ...
    it('should not dispatch action when paginationDisable is true', async () => {
      const mockSalaryRoles = [{ id: 1, roleName: 'Developer', baseSalary: 5000 }];
    ...
    it('should handle API errors', async () => {
      ...
      await expect(store.dispatch(actions.getSalaryRoleList({}))).rejects.toThrow(
        'Failed to fetch salary roles'
      );
    });
  ...
  describe('Error handling', () => {
    it('should handle 404 errors', async () => {
      ...
      await expect(store.dispatch(actions.getSalaryRoleList({}))).rejects.toThrow('Not Found');
    });
    ...
    it('should handle unauthorized errors', async () => {
      ...
      await expect(store.dispatch(actions.getSalaryRoleList({}))).rejects.toThrow('Unauthorized');
    });
  });
});

...
const CurrencyConvert = () => {
    ...
    const renderCurrency = (value) => {
        if (value) {
            return (
                <label className="badge label-currency mb-0">{value}</label>
            );
        } else {
                        ...
                        <Row>
                            <Col lg={12}>
                                ...
                                <DataTable
                                    ...
                                    pageCount={currency_converstion_list?.count ? Math.ceil(currency_converstion_list.count / pagination.pageSize) : 0}

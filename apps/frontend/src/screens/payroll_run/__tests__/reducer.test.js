...
describe('Payroll Run Reducer', () => {
  ...
  it('should handle EMPLOYEEPAYROLL.USER_APPROVER_GENERATER_DROPDOWN action', () => {
    ...
    expect(newState.user_approver_generater_dropdown_list).toEqual(mockUserApproverList);
  ...
  it('should maintain state immutability on updates', () => {
    ...
    expect(newState.payroll_employee_list).not.toBe(currentState.payroll_employee_list);
  });

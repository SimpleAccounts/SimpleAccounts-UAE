...
describe('Payroll Run Actions', () => {
  ...
  describe('getPayrollEmployeeList', () => {
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getPayrollEmployeeList('2024-01-01'))).rejects.toThrow(
  ...
  describe('getIncompletedEmployeeList', () => {
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getIncompletedEmployeeList())).rejects.toThrow(
        'Failed to fetch incomplete employees'
      );
    });
  ...
  describe('getSalaryDetailByEmployeeIdNoOfDays', () => {
    it('should fetch salary details successfully', async () => {
      ...
      const result = await store.dispatch(actions.getSalaryDetailByEmployeeIdNoOfDays(employeeId));
  ...
  describe('getEmployeeListWithDetails', () => {
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getEmployeeListWithDetails())).rejects.toThrow(
  ...
  describe('updateSalaryComponentAsNoOfDays', () => {
    it('should update salary component successfully', async () => {
      ...
      const result = await store.dispatch(actions.updateSalaryComponentAsNoOfDays(updateData));
    ...
    it('should handle update error', async () => {
      ...
      await expect(store.dispatch(actions.updateSalaryComponentAsNoOfDays({}))).rejects.toThrow(
        'Update failed'
      );
    });
  });
  ...
  describe('generateSalary', () => {
    ...
    it('should handle generation error', async () => {
      ...
      await expect(store.dispatch(actions.generateSalary({}))).rejects.toThrow(
  ...
  describe('getPayrollList', () => {
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getPayrollList({}))).rejects.toThrow(
  ...
  describe('updateCompany', () => {
    ...
    it('should handle update error', async () => {
      ...
      await expect(store.dispatch(actions.updateCompany({}))).rejects.toThrow('Update failed');
    });

								...
								if (empList && empList?.length > 0) {
									...
									empList.map((obj) => {
										...
										if (
											...
											(endDateCheck.isBefore(payEndDate) &&
												endDateCheck.isAfter(payStartDate)) ||
											...
											(payEndDate.isBefore(endDateCheck) &&
												payEndDate.isAfter(startDateCheck)) ||
															...
															<Col>
																<FormGroup>
																	<Label htmlFor="payrollApprover">
																		...
																		>
																			It is mandatory to have an approver for
																			payroll submission. Otherwise, it is not
																			mandatory.
																		</UncontrolledTooltip>
																	</Label>
																	<Controller

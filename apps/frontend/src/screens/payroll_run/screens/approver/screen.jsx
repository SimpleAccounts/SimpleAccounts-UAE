                                                ...
                                                <Form onSubmit={handleSubmit(onFormSubmit)}>
                                                    ...
                                                    <Row>
                                                        <Col lg={6}>
                                                            <Label>
                                                                {' '}
                                                                Status : <span style={{ fontSize: 'larger' }}> {renderStatus(payrollData.status)}</span>
                                                            </Label>
                                                        </Col>
                                                        <Col lg={6}>
                                                            {company_details?.generateSif &&
                                                                payrollData.status &&
                                                                (payrollData.status === 'Approved' || payrollData.status === 'Paid' || payrollData.status === 'Partially Paid') && (
                                                                    <Button
                                                                        type="button"
                                                                        color="primary"

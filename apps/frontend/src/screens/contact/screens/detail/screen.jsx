...
// Use migration shim for remaining reactstrap components
import { Row, Col, FormGroup, Label, UncontrolledTooltip } from 'components/migration';
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                          ...
                          <FormGroup>
                            <Label htmlFor="contactType">
                              ...
                              <UncontrolledTooltip placement="right" target="Contacttyprtip">
                                The contact type cannot be changed once a document has been created
                                for this contact.
                              </UncontrolledTooltip>
                            </Label>
                            <Controller
                ...
                <Card className="corp-card">
                  <CardContent className="pt-6">
                    ...
                    {/* Billing Details */}
                    <div className="mb-8">
                      <h4 className="text-md font-medium text-corp-text-secondary mb-4">

...
const DetailContact = ({
		...
		if (location.state && location.state.id) {
			...
			detailContactActions
				...
				.then((res) => {
					...
					if (taxTreatmentId) {
						if (taxTreatmentId === 1 || taxTreatmentId === 2 || taxTreatmentId === 3 || taxTreatmentId === 4) {
	...
	const deleteContact = () => {
		contactActions
			.getInvoicesCountContact(currentContactId)
			.then((res) => {
				if (res.data > 0) {
					commonActions.tostifyAlert(
						'error',
											...
											<Form onSubmit={handleSubmit(onSubmit)}>
												...
												<Row>
													...
													{watchedValues.taxTreatmentId && watchedValues.taxTreatmentId && (
														<Col md="4" style={{ display: watchedValues.taxTreatmentId === 1 || watchedValues.taxTreatmentId === 3 || watchedValues.taxTreatmentId === 5 ? '' : 'none' }}>
															<FormGroup>
												...
												<Row>
													...
													>
														...
														<FormGroup className="text-right">
															...
															>
																<i className="fa fa-ban"></i> {disabled1 ? 'Deleting...' : strings.Cancel}
															</Button>
														</FormGroup>
													</Col>
												</Row>

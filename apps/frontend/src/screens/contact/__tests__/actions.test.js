...
describe('Contact Actions', () => {
  ...
  describe('getContactList', () => {
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getContactList({}))).rejects.toThrow('Network error');
    });
  });
  ...
  describe('removeBulk', () => {
    ...
    it('should handle bulk delete error', async () => {
      ...
      await expect(store.dispatch(actions.removeBulk({ ids: [1, 2] }))).rejects.toThrow(
        'Delete failed'
      );
    });
  });
  ...
  describe('getContactTypeList', () => {
    ...
    it('should handle contact type list fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getContactTypeList())).rejects.toThrow(
  ...
  describe('getStateListForShippingAddress', () => {
    it('should fetch state list for shipping address successfully', async () => {
      ...
      const countryCode = 'AE';
      const result = await store.dispatch(actions.getStateListForShippingAddress(countryCode));
    ...
    it('should return empty array when no country code provided', async () => {
      const result = await store.dispatch(actions.getStateListForShippingAddress(null));
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getStateListForShippingAddress('AE'))).rejects.toThrow(
        'Failed to fetch states'
      );
    });
  });
  ...
  describe('getInvoicesCountContact', () => {
    it('should fetch invoices count for contact successfully', async () => {
      ...
      const result = await store.dispatch(actions.getInvoicesCountContact(contactId));
    ...
    it('should handle invoices count fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getInvoicesCountContact(123))).rejects.toThrow(
  ...
  describe('Error Handling', () => {
    it('should handle network timeout', async () => {
      ...
      await expect(store.dispatch(actions.getContactList({}))).rejects.toThrow('Request timeout');
    });
    ...
    it('should handle 401 unauthorized error', async () => {
      ...
      await expect(store.dispatch(actions.getCurrencyList())).rejects.toThrow('Unauthorized');
    });
    ...
    it('should handle 404 not found error', async () => {
      ...
      await expect(store.dispatch(actions.getInvoicesCountContact(999))).rejects.toThrow(
        'Not found'
      );
    });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle undefined country code in getStateListForShippingAddress', async () => {
      const result = await store.dispatch(actions.getStateListForShippingAddress(undefined));

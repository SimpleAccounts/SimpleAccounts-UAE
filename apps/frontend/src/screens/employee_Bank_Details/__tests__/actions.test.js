...
describe('Employee Bank Details Actions', () => {
  ...
  describe('removeBulkEmployee', () => {
    it('should delete multiple employees successfully', async () => {
      ...
      const result = await store.dispatch(actions.removeBulkEmployee(employeeIds));
    ...
    it('should handle delete error', async () => {
      ...
      await expect(store.dispatch(actions.removeBulkEmployee([1, 2]))).rejects.toThrow(
  ...
  describe('API Error Handling', () => {
    ...
    it('should handle 404 Not Found error', async () => {
      ...
      await expect(store.dispatch(actions.getCurrencyList())).rejects.toThrow('Resource not found');
    });
    ...
    it('should handle 500 Internal Server Error', async () => {
      ...
      await expect(store.dispatch(actions.removeBulkEmployee([1]))).rejects.toThrow(

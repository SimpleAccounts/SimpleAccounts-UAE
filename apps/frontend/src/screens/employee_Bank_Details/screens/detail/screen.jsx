...
const DetailEmployeePayroll = ({
  ...
  const form = useForm({
    resolver: zodResolver(detailEmployeePayrollSchema),
    defaultValues: {
      id: '',
      firstName: '',
      middleName: '',
  ...
  }, [location.state, employeeActions, employeeDetailActions, commonActions, history, reset]);
  ...
  const handleBothChange = (e, onChange) => {
    const value = e.target.value;

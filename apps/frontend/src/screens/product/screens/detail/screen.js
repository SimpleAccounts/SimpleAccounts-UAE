...
class DetailProduct extends React.Component {
  ...
  initializeData = () => {
    if (this.props.location.state && this.props.location.state.id) {
      ...
      let initCount = 0;
      this.props.productActions.getInvoicesCountProduct(this.props.location.state.id).then(res1 => {
        initCount = res1.data;
      });
      //getbyid
      ...
      this.props.productActions.getInventoryByProductId(this.props.location.state.id).then(res => {
  ...
  inventoryAccount = () => {
    try {
      this.props.productActions.getTransactionCategoryListForInventory().then(res => {
        if (res.status === 200) {
          this.setState(
            {
  ...
  handleSubmit = data => {
    ...
    const isInventoryEnabled = this.state.isInventoryEnabled
      ? this.state.isInventoryEnabled
      : false;
    const transactionCategoryId = this.state.inventoryAccount
      ? this.state.inventoryAccount[0].value
      : '';
    const inventoryId = this.state.inventoryId;
    const isActive = this.state.selectedStatus;
    const productCategoryId = data['productCategoryId'].value
  ...
  ProductvalidationCheck = value => {
    ...
    this.props.productActions.checkProductNameValidation(data).then(response => {
  ...
  checkChildActivitiesForProductId = id => {
    this.props.productActions.getInvoicesCountProduct(this.state.current_product_id).then(res => {
      if (res.data > 0) {
  ...
  deleteProduct = () => {
    const { current_product_id } = this.state;
    this.props.productActions.getInvoicesCountProduct(current_product_id).then(res => {
      if (res.data > 0) {
        this.props.commonActions.tostifyAlert(
          'error',
                            ...
                            <Formik
                              ...
                              validationSchema={Yup.object().shape({
                                ...
                                purchaseUnitPrice: Yup.string()
                                  .nullable()
                                  .when('productPriceType', {
                                    is: value => value && value.includes('PURCHASE'),
                                    then: Yup.string()
                                      .nullable()
                                      .required('Purchase price is required'),
                                    otherwise: Yup.string().nullable(),
                                  }),
                                purchaseTransactionCategoryId: Yup.string()
                                  .nullable()
                                  .when('productPriceType', {
                                    is: value => value && value.includes('PURCHASE'),
                                    then: Yup.string()
                                      .nullable()
                                      .required('Purchase category is required'),
                                    otherwise: Yup.string().nullable(),
                                  }),
                                salesTransactionCategoryId: Yup.string()
                                  .nullable()
                                  .when('productPriceType', {
                                    is: value => value && value.includes('SALES'),
                                    then: Yup.string()
                                      .nullable()
                                      .required('Selling category is required'),
                                    otherwise: Yup.string().nullable(),
                                  }),
                                salesUnitPrice: Yup.string()
                                  .nullable()
                                  .when('productPriceType', {
                                    is: value => value && value.includes('SALES'),
                                    then: Yup.string()
                                ...
                                productPriceType: Yup.string()
                                  .nullable()
                                  .required('At least one selling Type is required'),
                            ...
                            >
                              {props => (
                                <Form onSubmit={props.handleSubmit}>
                                      ...
                                      <FormGroup className="mb-3">
                                        ...
                                        <Input
                                          ...
                                          onChange={option => {
                                            ...
                                            this.ProductvalidationCheck(option.target.value);
                                          }}
                                          className={
                                            props.errors.productCode && props.touched.productCode
                                              ? 'is-invalid'
                                              : ''
                                          }
                                        />
                                        ...
                                        <Select
                                          ...
                                          value={
                                            ...
                                            selectOptionsFactory
                                              ...
                                              .find(
                                                option =>
                                                  option.value === +props.values.productCategoryId
                                              )
                                          }
                                          onChange={option => {
                                            // this.setState({
                                      ...
                                      <FormGroup className="mb-3">
                                        ...
                                        <Select
                                          isDisabled={
                                            ...
                                            !this.state.companyDetails.isRegisteredVat
                                          }
                                          options={
                                            vat_list
                                              ? selectOptionsFactory.renderOptions(
                                          ...
                                          value={
                                            ...
                                            selectOptionsFactory
                                              ...
                                              .find(
                                                option =>
                                                  option.value === +props.values.vatCategoryId
                                              )
                                          }
                                          onChange={option => {
                                            this.setState({
                                        ...
                                        <Select
                                          ...
                                          value={
                                            ...
                                            selectOptionsFactory
                                              ...
                                              .find(
                                                option => option.value == props.values.unitTypeId
                                              )
                                          }
                                          onChange={option => {
                                            if (option && option.value) {
                                              props.handleChange('unitTypeId')(option);
                                            } else {
                                  ...
                                  <Row
                                    style={{
                                      display: props.values.productType !== 'SERVICE' ? '' : 'none',
                                    }}
                                  >
                                    <Col lg={4}>
                                      <FormGroup check inline className="mb-3">
                                  ...
                                  <Row>
                                    {this.state.exciseTaxCheck === true && (
                                      <Col
                                        style={{
                                          display:
                                            props.values.productType !== 'SERVICE' ? '' : 'none',
                                        }}
                                        lg={4}
                                      >
                                        <FormGroup className="mb-3">
                                          ...
                                          <Select
                                            ...
                                            value={
                                              ...
                                              selectOptionsFactory
                                                ...
                                                .find(
                                                  option =>
                                                    option.value === +props.values.exciseTaxId
                                                )
                                            }
                                            onChange={option => {
                                              if (option && option.value) {
                                                props.handleChange('exciseTaxId')(option);
                                              } else {
                                                props.handleChange('exciseTaxId')('');
                                              }
                                            }}
                                            className={
                                              props.errors.exciseTaxId && props.touched.exciseTaxId
                                                ? 'is-invalid'
                                                : ''
                                            }
                                          />
                                          ...
                                          <Input
                                            ...
                                            onChange={event => {
                                              if (
                                                ...
                                                const nextValue =
                                                  props.values.productPriceType.filter(
                                                    value => value !== 'SALES'
                                                  );
                                                props.setFieldValue('productPriceType', nextValue);
                                              } else {
                                                const nextValue =
                                                  props.values.productPriceType &&
                                                  props.values.productPriceType.concat('SALES');
                                                props.setFieldValue('productPriceType', nextValue);
                                              }
                                            }}
                                            checked={
                                        ...
                                        <Col>
                                          <FormGroup className="mb-3">
                                            ...
                                            <Select
                                              ...
                                              value={
                                                salesCategory &&
                                                props.values.salesTransactionCategoryLabel
                                                  ? salesCategory
                                                      .find(
                                                        item =>
                                                          item.label ===
                                              ...
                                              onChange={option => {
                                                if (option && option.value) {
                                                  props.handleChange('salesTransactionCategoryId')(
                                                    option
                                                  );
                                                } else {
                                                  props.handleChange('salesTransactionCategoryId')(
                                          ...
                                          <Input
                                            ...
                                            onChange={event => {
                                              if (
                                                ...
                                                const nextValue =
                                                  props.values.productPriceType &&
                                                  props.values.productPriceType.concat('PURCHASE');
                                                props.setFieldValue('productPriceType', nextValue);
                                              }
                                            }}
                                            checked={
                                        ...
                                        <Col>
                                          <FormGroup className="mb-3">
                                            ...
                                            <Select
                                              ...
                                              value={
                                                purchaseCategory &&
                                                props.values.purchaseTransactionCategoryLabel
                                                  ? purchaseCategory
                                                      .find(
                                                        item =>
                                                          item.label ===
                                  ...
                                  >
                                    {config.INVENTORY_MODULE && (
                                      <Col
                                        ...
                                        style={{
                                          display:
                                            props.values.isInventoryEnabled != true ? 'none' : '',
                                        }}
                                      >
                                        <FormGroup check inline className="mb-3">
                                          <Label

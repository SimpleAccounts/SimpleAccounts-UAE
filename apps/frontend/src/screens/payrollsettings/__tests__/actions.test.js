...
describe('Payroll Settings Actions', () => {
  ...
  describe('getPayrollSettings', () => {
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getPayrollSettings(true))).rejects.toThrow(
    ...
    it('should handle server errors gracefully', async () => {
      ...
      await expect(store.dispatch(actions.getPayrollSettings(false))).rejects.toThrow(
  ...
  describe('getCompanyById', () => {
    ...
    it('should handle unauthorized access', async () => {
      ...
      await expect(store.dispatch(actions.getCompanyById())).rejects.toThrow('Unauthorized');
    });
    ...
    it('should handle network errors', async () => {
      ...
      await expect(store.dispatch(actions.getCompanyById())).rejects.toThrow('Network error');
    });
    ...
    it('should handle validation errors', async () => {
      ...
      await expect(store.dispatch(actions.getCompanyById())).rejects.toThrow('Validation failed');
    });

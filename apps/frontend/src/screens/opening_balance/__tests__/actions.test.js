...
describe('Opening Balance Actions', () => {
  ...
  describe('getOpeningBalanceList', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await expect(store.dispatch(actions.getOpeningBalanceList({}))).rejects.toThrow(
  ...
  describe('getOpeningBalanceById', () => {
    ...
    it('should handle API errors when fetching by ID', async () => {
      ...
      await expect(store.dispatch(actions.getOpeningBalanceById(999))).rejects.toThrow(
    ...
    it('should handle network errors', async () => {
      ...
      await expect(store.dispatch(actions.getOpeningBalanceById(1))).rejects.toThrow(
        'Network Error'
      );
    });
  });

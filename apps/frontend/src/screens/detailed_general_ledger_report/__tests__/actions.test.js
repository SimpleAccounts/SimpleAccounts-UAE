...
describe('Detailed General Ledger Report Actions', () => {
  ...
  describe('getDetailedGeneralLedgerList', () => {
    it('should fetch detailed general ledger list successfully', async () => {
      ...
      const result = await store.dispatch(actions.getDetailedGeneralLedgerList(postData));
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getDetailedGeneralLedgerList(postData))).rejects.toThrow(
        'Network error'
      );
    });
  ...
  describe('getTransactionCategoryList', () => {
    it('should fetch transaction category list successfully', async () => {
      ...
      const result = await store.dispatch(actions.getTransactionCategoryList(postData));
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getTransactionCategoryList(postData))).rejects.toThrow(

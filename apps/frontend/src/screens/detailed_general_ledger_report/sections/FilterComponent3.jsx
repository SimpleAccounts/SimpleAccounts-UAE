...
const FilterComponent3 = (props) => {
	const { setCutomPeriod, chart_of_account_list, customPeriod, generateReport, hideExportOptionsFunctionality, handleCancel } = props;
	...
	const getDateRange = useCallback((selectedOption) => {
		...
		<Form>
			<Row>
				<Col lg={3}>
					<div className={`align-items-center pull left ${selectedPeriod !== 'customRange' && selectedPeriod !== 'asOn'}`}>
						<FormGroup>
							<Label htmlFor="reportingPeriod" style={{ color: 'black', fontWeight: '600', marginTop: '15px' }}>
			...
			<Row>
				...
				<Col lg={3}>
					{showEndDate && (
						<FormGroup className="mb-3">
							<Label htmlFor="endDate" style={{ color: 'black', marginTop: '15px', borderColor: 'black' }}>
								{strings.EndDate}
							</Label>
							<Controller
								name="endDate"
			...
			<Row>
				<Col lg={3}>
					<FormGroup className="mb-3">
						<Label htmlFor="reportBasis" style={{ color: 'black', fontWeight: '600', marginTop: '15px' }}>
							{strings.ReportBasis}
						</Label>
						<Controller
							name="reportBasis"
				...
				<Col lg={3}>
					<FormGroup className="mb-3">
						<Label htmlFor="chart_of_account" style={{ color: 'black', fontWeight: '600', marginTop: '15px' }}>
								...
								<Select
									...
									options={
										chart_of_account_list
											? selectOptionsFactory.renderOptions('label', 'value', chart_of_account_list, 'Chart of Account')
											: []
									}
									value={value}
									onChange={(option) => onChange(option)}

...
class ExplainTransactionModal extends React.Component {
  ...
  checkChartOfAccount = () => {
    const { transactionAmount, currentBalance, submitBtnClick, transactionCategoryTypeList } =
      this.state;
                    ...
                    explainList.map((item, index) => (
                      <div className="d-flex detail-row">
                        <div className="sub-container">
                          ...
                          {explainList[`${index}`].transactionCategoryId.value && (
                            <div className="mb-3" style={{ width: '40%' }}>
                              ...
                              <Select
                                options={
                                  categoryList[`${explainList[`${index}`].categoryLabel}`]

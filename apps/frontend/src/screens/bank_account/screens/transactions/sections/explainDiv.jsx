...
const ExplainDiv = (props) => {
	const { openExplainTransactionModal, selectedData, transactionsActions, commonActions, closeExplainTransactionModal } = props;
					...
					{moreDetails && (
						<div className="">
							<div className="col-lg-6">
								...
								{explainList[0].chartOfAccountCategoryId.label ===
									'Expenses' && (
									<div>
										<div className="form-group row align-items-center ">

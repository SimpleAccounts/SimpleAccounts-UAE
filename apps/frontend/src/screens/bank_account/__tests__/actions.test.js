...
describe('Bank Account Actions', () => {
  ...
  describe('getAccountTypeList', () => {
    ...
    it('should handle account type list fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getAccountTypeList())).rejects.toThrow(
  ...
  describe('getBankAccountList', () => {
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getBankAccountList({}))).rejects.toThrow('Network error');
    });
  });
  ...
  describe('deleteBankAccount', () => {
    it('should delete bank account successfully', async () => {
      ...
      const result = await store.dispatch(actions.deleteBankAccount(bankAccountId));
    ...
    it('should handle delete error', async () => {
      ...
      await expect(store.dispatch(actions.deleteBankAccount(123))).rejects.toThrow('Delete failed');
    });
  });
  ...
  describe('removeBankAccountByID', () => {
    it('should remove bank account by ID successfully', async () => {
      ...
      const result = await store.dispatch(actions.removeBankAccountByID(bankAccountId));
    ...
    it('should handle remove error', async () => {
      ...
      await expect(store.dispatch(actions.removeBankAccountByID(456))).rejects.toThrow(
        'Remove failed'
      );
    });
  });
  ...
  describe('removeBulkBankAccount', () => {
    it('should remove bulk bank accounts successfully', async () => {
      ...
      const result = await store.dispatch(actions.removeBulkBankAccount(mockIds));
    ...
    it('should handle bulk delete error', async () => {
      ...
      await expect(store.dispatch(actions.removeBulkBankAccount({ ids: [1, 2] }))).rejects.toThrow(
        'Bulk delete failed'
      );
    });
  });
  ...
  describe('getExplainCount', () => {
    it('should fetch explain count successfully', async () => {
      ...
      const result = await store.dispatch(actions.getExplainCount(bankAccountId));
    ...
    it('should handle explain count fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getExplainCount(789))).rejects.toThrow(
  ...
  describe('Error Handling', () => {
    it('should handle network timeout', async () => {
      ...
      await expect(store.dispatch(actions.getBankAccountList({}))).rejects.toThrow(
        'Request timeout'
      );
    });

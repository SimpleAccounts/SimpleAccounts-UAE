...
describe('Import Bank Statement Actions', () => {
  ...
  describe('getTemplateList', () => {
    ...
    it('should handle network timeout', async () => {
      ...
      await expect(store.dispatch(actions.getTemplateList())).rejects.toThrow('Request timeout');
    });
  });
  ...
  describe('parseFile', () => {
    ...
    it('should handle parse error', async () => {
      ...
      await expect(store.dispatch(actions.parseFile({}))).rejects.toThrow('File parsing failed');
    });
    ...
    it('should handle invalid file format error', async () => {
      ...
      await expect(store.dispatch(actions.parseFile({}))).rejects.toThrow('Invalid file format');
    });
  ...
  describe('importTransaction', () => {
    it('should import transactions successfully', async () => {
      ...
      const result = await store.dispatch(actions.importTransaction(mockImportData));
    ...
    it('should handle import error', async () => {
      ...
      await expect(store.dispatch(actions.importTransaction({}))).rejects.toThrow('Import failed');
    });
    ...
    it('should handle validation errors', async () => {
      ...
      await expect(store.dispatch(actions.importTransaction({}))).rejects.toThrow(
        'Validation failed'
      );
    });
  ...
  describe('downloadcsv', () => {
    ...
    it('should handle download error', async () => {
      ...
      await expect(store.dispatch(actions.downloadcsv({}))).rejects.toThrow('Download failed');
    });
    ...
    it('should handle file not found error', async () => {
      ...
      await expect(store.dispatch(actions.downloadcsv({}))).rejects.toThrow('File not found');
    });
  });
});

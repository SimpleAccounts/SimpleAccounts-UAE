const fr = {
  ...
  Guide:
    'Nouveau sur SimpleAccounts ? Laissez-nous vous guider pour tirer le meilleur parti de SimpleAccounts',
  ...
  Refer:
    "Vous avez des questions qui n'ont toujours pas de réponse ? Parlez directement à notre maître comptable",
  FAQ: 'FAQ',
  ...
  Status: 'Statut',
  Message:
    "La date de transaction ne peut pas être antérieure à la date d'ouverture de la banque ou à la date de dernier rapprochement",
  ...
  //PROFILE
  UniquePasswordNote:
    '* Veuillez utiliser un mot de passe unique.Ce mot de passe a été utilisé précédemment. ',
  ...
  Suppliessubjecttothereversechargeprovisions:
    "Fournitures soumises aux dispositions d'autoliquidation",
  Due: 'Dû',
  ...
  DoyouwishtorequestarefundfortheaboveamountofreclaimableVAT:
    'Vous souhaitez demander un remboursement pour le montant de TVA récupérable ci-dessus?',

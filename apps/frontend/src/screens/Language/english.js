const en = {
  ...
  AmountShouldBeLessThanOrEqualToTheBalanceDue:
    'Amount should be less than or equal to the Balance Due',
  ...
  TotalDeductionsShouldBeLessThanTotalEarnings:
  ...
  PercentOfCTC: 'Percent of CTC',
  FlatAmount: 'Flat Amount',
  SalaryComponentCreateNote:
    "The component cannot be deleted if it is linked to the employee's salary setup.",
  ...
  ComponentTypeTooltip:
    "The type of the component cannot be changed, once it is linked to the employee's salary setup.",
  Earning: 'Earning',
  Deduction: 'Deduction',
  ...
  DoyouwishtorequestarefundfortheaboveamountofreclaimableVAT:
    'Do you wish to request a refund for the above amount of reclaimable VAT?',
  ...
  SubscriptionErrorMessage:
    'Not able to validate subscription, please contact support.ae@simpleaccounts.io',
  ...
  APaySlipWillBeMailedToTheSelectedEmployees:
    'A pay slip will be mailed to the selected employees.',

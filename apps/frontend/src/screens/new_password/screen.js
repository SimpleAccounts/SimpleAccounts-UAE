        ...
        <CardHeader className="space-y-6 text-center pb-8 border-b border-border/40 bg-slate-50/50 dark:bg-slate-900/50">
          ...
          <div className="animate-fade-in space-y-2" style={{ animationDelay: '100ms' }}>
            <CardTitle className="text-3xl font-bold tracking-tight bg-gradient-to-r from-primary to-blue-600 bg-clip-text text-transparent">
              {success ? 'Password Created!' : 'Create Password'}
            </CardTitle>
            <CardDescription className="text-base">
              {success
                ? 'Your password has been successfully set'
                : 'Please set your new account password below'}
            </CardDescription>
          </div>
        </CardHeader>
            ...
            <>
              {alert && (
                ...
                >
                  <AlertDescription>
                    {alert.message}{' '}
                    {alert.message.includes('Verification Link Is Expired') && (
                      <Button
                        variant="link"
                ...
                >
                  <FormField
                    ...
                    render={({ field, fieldState }) => (
                      <FormItem>
                        <FormLabel className="font-semibold" htmlFor="reg-password">
                  ...
                  <FormField
                    ...
                    render={({ field, fieldState }) => (
                      <FormItem>
                        <FormLabel className="font-semibold" htmlFor="confirmPassword">
                          <span className="text-destructive" aria-hidden="true">
                            *{' '}
                          </span>
                          Confirm Password

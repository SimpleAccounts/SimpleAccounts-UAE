...
describe('VAT Transactions Actions', () => {
  ...
  describe('vatTransactionList', () => {
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.vatTransactionList({}))).rejects.toThrow('Network error');
    });
    ...
    it('should handle server errors gracefully', async () => {
      ...
      await expect(store.dispatch(actions.vatTransactionList({}))).rejects.toThrow(
    ...
    it('should not dispatch actions on pagination disabled', async () => {
      ...
      const result = await store.dispatch(actions.vatTransactionList({ paginationDisable: true }));

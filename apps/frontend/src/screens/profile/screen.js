...
class Profile extends React.Component {
  ...
  handleUserSubmit = data => {
    ...
    // }
    {
      this.setState({
        ...
        loadingMsg: 'Updating Users Profile',
      });
    }
    this.props.profileActions
      .updateUser(formData)
      .then(res => {
        if (res.status === 200) {
          this.props.commonActions.tostifyAlert('success', 'Profile Updated Successfully');
  ...
  resetPassword = email => {
    ...
    api(data)
      ...
      .catch(err => {
        this.setState({
          alert: <Message type="danger" content="Invalid Email Address" />,
        });
      });
  };
  validateCurrentPassword = (username, password) => {
    ...
    this.props.authActions
      ...
      .catch(err => {
        if (err.status == 401) this.setState({ currentPasswordMatched: false });
      });
  };
  ...
  render() {
    ...
    const { currency_list, country_list, role_list, invoicing_state_list, company_state_list } =
      this.props;
    return loading == true ? (
                                    ...
                                    <Row>
                                      <Col lg={10}>
                                            ...
                                            <FormGroup>
                                              ...
                                              <Input
                                                ...
                                                onChange={option => {
                                                  if (
                                                    option.target.value === '' ||
                                                    this.regExAlpha1.test(option.target.value)
                                                  ) {
                                        ...
                                        <Row>
                                          ...
                                          <Col lg={6}>
                                            <FormGroup className="mb-3">
                                              <Label htmlFor="date">{strings.DateOfBirth}</Label>
                                              <DatePicker
                                                ...
                                                value={
                                                  props.values.dob
                                                    ? dayjs(props.values.dob).format('DD-MM-YYYY')
                                                    : ''
                                                }
                                                onChange={value => {
                                              ...
                                              <Select
                                                ...
                                                value={
                                                  ...
                                                  selectOptionsFactory
                                                    ...
                                                    .find(
                                                      option =>
                                                        option.value === +props.values.roleId
                                                    )
                                                }
                                                isDisabled={true}
                                                onChange={option => {
                            ...
                            <Col lg="12">
                              <Formik
                                ...
                                validate={values => {
                                  ...
                                  if (
                                    values.isRegisteredVat === true &&
                                    !values.vatRegistrationDate
                                  ) {
                                ...
                                validationSchema={Yup.object().shape({
                                  ...
                                  vatRegistrationNumber: Yup.string().when('isRegisteredVat', {
                                    is: value => value === true,
                                    then: Yup.string()
                                      .required('Tax registration number is required')
                                      .test('vatRegistrationNumber', 'Invalid TRN', value => {
                                        if (value > 15) {
                                          return true;
                                        } else {
                                          return false;
                                  ...
                                  <Form onSubmit={props.handleSubmit}>
                                    ...
                                    <Row>
                                      ...
                                      <Col lg={10}>
                                          ...
                                          <Col lg={4}>
                                            <FormGroup className="mb-3">
                                              ...
                                              <Input
                                                ...
                                                placeholder={
                                                  strings.Enter + strings.CompanyRegistrationNo
                                                }
                                              ...
                                              <Input
                                                ...
                                                onChange={option => {
                                                  if (
                                                    ...
                                                    props.handleChange('telephoneNumber')(option);
                                                  }
                                                }}
                                                //value={props.values.telephoneNumber}
                                                className={
                                        ...
                                        <Row
                                          style={{
                                            display: props.values.countryName !== 1 ? '' : 'none',
                                          }}
                                        >
                                          <Col lg={4}>
                                            <FormGroup className="mb-3">
                                              ...
                                              <Input
                                                ...
                                                placeholder={
                                                  strings.Enter + strings.CompanyAddressLine1
                                                }
                                                rows="5"
                                                value={
                                                  isSame
                                                    ? this.state.companyAddress.companyAddressLine1
                                          ...
                                          <Col lg={4}>
                                            <FormGroup className="mb-3">
                                              ...
                                              <Input
                                                ...
                                                placeholder={
                                                  strings.Enter + strings.CompanyAddressLine2
                                                }
                                                rows="5"
                                                value={
                                                  isSame
                                                    ? this.state.companyAddress.companyAddressLine2
                                                    ...
                                                    : country_list &&
                                                      selectOptionsFactory
                                                        ...
                                                        .find(
                                                          option =>
                                                            option.value ===
                                                            +props.values.companyCountryCode
                                                        )
                                                }
                                                onChange={option => {
                                                  if (option && option.value) {
                                                    ...
                                                    props.handleChange('companyStateCode')('');
                                          ...
                                          <Col lg={4}>
                                            <FormGroup className="mb-3">
                                              <Label htmlFor="product_code">
                                                <span className="text-danger">* </span>{' '}
                                                {props.values.companyCountryCode === 229
                                                  ? strings.Emirate
                                                  : strings.StateRegion}
                                              </Label>
                                              <Select
                                          ...
                                          <Col lg={4}>
                                            <FormGroup className="mb-3">
                                              ...
                                              <Input
                                                ...
                                                value={
                                                  isSame
                                                    ? this.state.companyAddress.companyCity
                                        ...
                                        <Row>
                                          {props.values.companyCountryCode == 229 ||
                                          props.values.companyCountryCode.value == 229 ? (
                                            <Col lg={4}>
                                              <FormGroup className="mb-3">
                                                ...
                                                <Input
                                                  ...
                                                  value={
                                                    isSame
                                                      ? this.state.companyAddress.companyPoBoxNumber
                                                  ...
                                                  onChange={option => {
                                                    if (
                                                      ...
                                                      props.handleChange('companyPoBoxNumber')(
                                                        option
                                                      );
                                                    }
                                                  }}
                                            ...
                                            <FormGroup check inline className="mb-3">
                                              <div>
                                                <Input
                                                  ...
                                                  disabled={
                                                    this.state.initCompanyData.isRegisteredVat &&
                                                    !isVatEditable
                                                  }
                                                  onChange={value => {
                                                    console.log(value, value.target.value, 'Value');
                                                    if (value != null) {
                                                      props.handleChange('isRegisteredVat')(value);
                                                    } else {
                                        ...
                                        <Row
                                          style={{
                                            display:
                                              props.values.isRegisteredVat === true ? '' : 'none',
                                          }}
                                        >
                                          <Col lg={4}>
                                            <FormGroup className="mb-3">
                                          ...
                                          <Col lg={4}>
                                            <FormGroup className="mb-3">
                                              <Label htmlFor="expense_date">
                                                ...
                                                <div className="tooltip-icon nav-icon fas fa-question-circle ml-1">
                                                  <span className="tooltiptext">
                                                    Please note that you cannot update <br></br>{' '}
                                                    this detail once you have created a document.
                                                  </span>
                                                </div>
                                              </Label>
                                              <DatePicker
                                          ...
                                          <Col lg={4}>
                                            <FormGroup>
                                              ...
                                              <Input
                                                ...
                                                placeholder={
                                                  strings.Enter + strings.CurrentPassword
                                                }
                                                onChange={option => {
                                                  props.handleChange('currentPassword')(option);

                                                  this.validateCurrentPassword(
                                                    this.state.initUserData.email,
                                                    option.target.value
                                                  );
                                                }}
                                                className={
                                          ...
                                          <Col lg={4}>
                                            <FormGroup>
                                              ...
                                              <Input
                                                ...
                                                placeholder={
                                                  strings.Enter + strings.ConfirmPassword
                                                }
                                                onChange={value => {

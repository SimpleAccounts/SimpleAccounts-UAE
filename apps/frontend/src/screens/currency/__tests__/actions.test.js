...
describe('Currency Actions', () => {
  ...
  describe('getCurrencyList', () => {
    ...
    it('should handle network timeout errors', async () => {
      ...
      await expect(store.dispatch(actions.getCurrencyList())).rejects.toThrow('Network timeout');
    });
  ...
  describe('Action error handling', () => {
    ...
    it('should handle promise rejection', async () => {
      ...
      await expect(store.dispatch(actions.getCurrencyList())).rejects.toThrow('Promise rejected');
    });
  });
});

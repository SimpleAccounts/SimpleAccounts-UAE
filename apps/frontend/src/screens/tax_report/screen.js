...
import { Card, CardHeader, CardBody, FormGroup, Label, Form } from 'reactstrap';
            ...
            <Card>
              <CardHeader>
                <div className="d-flex flex-wrap align-items-start justify-content-between">
                  <div>
                    ...
                    <p className="pl-4">
                      <i className="pl-2">Last updated at 28 October 2019</i>
                    </p>
                  </div>
              ...
              <CardBody>
                <div className="table-wrapper">
                  <BootstrapTable data={tempdata} exportCSV hover pagination filter={true}>
                    <TableHeaderColumn
                      isKey
              ...
              <CardBody>
                <div className="table-wrapper">
                  <BootstrapTable data={tempdata} exportCSV hover pagination filter={true}>
                    ...
                    <TableHeaderColumn dataFormat={this.getAction}>Action</TableHeaderColumn>
                  </BootstrapTable>
                </div>
              </CardBody>
            </Card>

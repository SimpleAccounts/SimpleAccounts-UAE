...
import { Card, CardBody, Row, Col, Table } from 'components/migration';
          ...
          <CardBody style={{ margin: '1rem', border: 'solid 1px', borderColor: '#c8ced3' }}>
              ...
              >
                ...
                >
                  <div style={{ marginTop: '0.5rem' }}>
                    ...
                    <div>
                      {companyData && (companyData.companyCity ? companyData.companyCity : '')}
                    </div>
                    <div>
                      {companyData &&
            ...
            >
              ...
              >
                <div>
                  ...
                  {debitNoteData &&
                    debitNoteData.taxTreatment &&
                    debitNoteData.taxTreatment.includes('NON') == false && (
                      <div className="mb-1 ml-2">
                ...
                <div>
                  ...
                  >
                    <thead className="header-row" style={{ fontSize: '12px' }}>
                      <tr>
                        ...
                        {isCNWithoutProduct && (
                          <th style={{ textAlign: 'right' }}>{strings.DebitAmount}</th>
                        )}
                      ...
                      <tr>
                        ...
                        <td>
                          {debitNoteData.status
                            ? debitNoteData.status === 'Partially Paid'
                              ? 'Partially Debited'
                              : debitNoteData.status
                            : ''}
                        </td>
                  ...
                  <div className="text-right">
                    {debitNoteData.exchangeRate && debitNoteData.exchangeRate > 1 ? (
                      <>
                        <b>{strings.Exchangerate}:</b> {debitNoteData.exchangeRate}
                      </>
                    ) : (
                      ''
                    )}
            ...
            {isCNWithoutProduct == false && (
              <>
                ...
                <Table
                  className="table-striped"
                  style={{ border: '1px solid', borderColor: '#c8ced3' }}
                >
                  <thead className="header-row" style={{ fontSize: '12px' }}>
                    <tr>

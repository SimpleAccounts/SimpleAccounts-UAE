...
describe('General Settings Actions', () => {
  ...
  describe('getTestUserMailById', () => {
    ...
    it('should handle API errors gracefully', async () => {
      ...
      await expect(store.dispatch(actions.getTestUserMailById(999))).rejects.toThrow('API Error');
    });
  ...
  describe('getGeneralSettingDetail', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await expect(store.dispatch(actions.getGeneralSettingDetail())).rejects.toThrow(
  ...
  describe('updateGeneralSettings', () => {
    ...
    it('should handle update errors', async () => {
      ...
      await expect(store.dispatch(actions.updateGeneralSettings(settingsData))).rejects.toThrow(
        'Update failed'
      );
    });
    ...
    it('should handle validation errors', async () => {
      ...
      await expect(store.dispatch(actions.updateGeneralSettings(invalidData))).rejects.toThrow(
        'Validation failed'
      );
    });
  ...
  describe('Action error handling', () => {
    ...
    it('should propagate API errors correctly', async () => {
      ...
      await expect(actions.getGeneralSettingDetail()(dispatch)).rejects.toThrow('Unauthorized');
    });
  });
});

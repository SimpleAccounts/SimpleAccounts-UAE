	...
	return (
		<div className="transactions-report-screen">
			<div className="animated fadeIn">
				<Card>
					<CardHeader><h5>Migrate History</h5></CardHeader>
					<CardBody style={{ margin: "0px 176px 0px 176px" }}>
						<h1 className="text-center">Migration Summary</h1>
						<br />
						<Row className="mb-4 mt-2">
							<Col lg={4}> <b>Migration Beginning Date: </b>{dayjs(migrationBeginningDate).format('DD/MM/YYYY')}</Col>
							<Col lg={4} className="text-center"><b>Source Application: </b>{sourceApplication} </Col>
							<Col lg={4} className="text-right"><b>Execution Date: </b> {dayjs(executionDate).format('DD/MM/YYYY')}</Col>
						</Row>				

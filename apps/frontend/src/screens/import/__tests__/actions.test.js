...
describe('Import Actions', () => {
  ...
  describe('migrationProduct', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await expect(store.dispatch(actions.migrationProduct())).rejects.toThrow(
        'Failed to fetch migration products'
      );
    });
  });
  ...
  describe('getVersionListByPrioductName', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await expect(store.dispatch(actions.getVersionListByPrioductName('Test'))).rejects.toThrow(
  ...
  describe('getFileData', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await expect(store.dispatch(actions.getFileData({ fileName: 'test.csv' }))).rejects.toThrow(
        'File not found'
      );
    });
  });
  ...
  describe('downloadcsv', () => {
    ...
    it('should handle download errors', async () => {
      ...
      await expect(store.dispatch(actions.downloadcsv('test.csv'))).rejects.toThrow(
        'Download failed'
      );
    });
  });

...
describe('VAT Code Actions', () => {
  ...
  describe('getVatList', () => {
    ...
    it('should fetch VAT list without parameters', async () => {
      const mockVatList = [{ id: 1, name: 'Standard Rate', vatPercentage: 5 }];
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getVatList({}))).rejects.toThrow('Network error');
    });
  ...
  describe('getVatByID', () => {
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getVatByID(999))).rejects.toThrow('VAT not found');
    });
  ...
  describe('deleteVat', () => {
    ...
    it('should handle delete error', async () => {
      ...
      await expect(store.dispatch(actions.deleteVat({ ids: [1, 2] }))).rejects.toThrow(
        'Delete failed'
      );
    });
  ...
  describe('getVatCount', () => {
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getVatCount(123))).rejects.toThrow(

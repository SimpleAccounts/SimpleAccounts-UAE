            ...
            >
              ...
              >
                <div>
                  ...
                  <div className="mb-1 ml-2">
                    <b>
                      {RFQData.organisationName ? RFQData.organisationName : RFQData.supplierName}
                    </b>
                  </div>
                  ...
                  {RFQData &&
                    RFQData.taxtreatment &&
                    RFQData.taxtreatment.includes('NON') == false && (
                      <div className="mb-1 ml-2">
                        {strings.VATRegistrationNo}: {companyData.vatRegistrationNumber}
                      </div>
                    )}
                ...
                <div style={{ width: '27%' }}>
                  <br />
                  <div className="mb-1 ml-2">
                    <b>{strings.RFQNUMBER}: </b> # {RFQData.rfqNumber}{' '}
                  </div>
                  {RFQData.receiptNumber && (
                    <div className="mb-1 ml-2">
                  ...
                  <div className="mb-1 ml-2">
                    <b>{strings.RFQDate}: </b> {dayjs(RFQData.RFQDATE).format('DD MMM YYYY')}
                  </div>
                  <div className="mb-1 ml-2">
                    <b>{strings.ExpiryDate}: </b>
                    {dayjs(RFQData.rfqExpiryDate).format('DD MMM YYYY')}
                  </div>
                  <div className="mb-1 ml-2">
                    <b>{strings.Status}: </b>
                    {this.renderRFQStatus(RFQData.status)}
                  </div>
                  <br />
              ...
              >
                <div style={{ width: '100%' }}>
                  <Table className="table-clear cal-table">
                    <tbody>
                      {RFQData.totalExciseAmount && RFQData.totalExciseAmount > 0 ? (
                        <tr>
                          <td style={{ width: '40%' }}>
                          ...
                          >
                            ...
                            <span>
                              {RFQData.totalExciseAmount
                                ? RFQData.currencyIsoCode +
                                  ' ' +
                                  RFQData.totalExciseAmount.toLocaleString(navigator.language, {
                                    minimumFractionDigits: 2,
                                    maximumFractionDigits: 2,
                                  })
                                : RFQData.currencyIsoCode +
                      ...
                      {RFQData.discount && RFQData.discount > 0 ? (
                        <tr>
                          <td style={{ width: '40%' }}>
                            <strong>
                              {strings.Discount}
                              {RFQData.discountPercentage ? `(${RFQData.discountPercentage}%)` : ''}
                            </strong>
                          </td>
                          <td
                            style={{
                          ...
                          >
                            ...
                            <span>
                              {RFQData.discount
                                ? RFQData.currencyIsoCode +
                                  ' ' +
                                  RFQData.discount.toLocaleString(navigator.language, {
                                    minimumFractionDigits: 2,
                                  })
                                : RFQData.currencyIsoCode +
                                  ' ' +
                          ...
                          <span>
                            {RFQData.totalAmount
                              ? RFQData.currencyIsoCode +
                                ' ' +
                                (
                                  parseFloat(RFQData.totalAmount) -
                                  parseFloat(RFQData.totalVatAmount) -
                                  parseFloat(RFQData.totalExciseAmount)
                        ...
                        >
                          ...
                          <span>
                            {RFQData.totalVatAmount
                              ? RFQData.currencyIsoCode +
                                ' ' +
                                RFQData.totalVatAmount.toLocaleString(navigator.language, {
                                  minimumFractionDigits: 2,
                                  maximumFractionDigits: 2,
                                })
                              : RFQData.currencyIsoCode +
                        ...
                        >
                          ...
                          <span>
                            {RFQData.totalAmount
                              ? RFQData.currencyIsoCode +
                                ' ' +
                                RFQData.totalAmount.toLocaleString(navigator.language, {
                                  minimumFractionDigits: 2,
                                })
                              : 0}
                          </span>

...
class CreateTransactionCategory extends React.Component {
  ...
  handleSubmit = (e, status) => {
    ...
    const { categoryName, categoryCode, categoryDiscription, selectVatCategoryCode, defaltFlag } =
      this.state.transactionData;
                        ...
                        {selectedTransactionCategory ? (
                          <FormGroup className="auto-suggestion-form-group">
                            ...
                            <Autosuggest
                              ...
                              onSuggestionsFetchRequested={this.onParentSuggestionsFetchRequested}
                              onSuggestionsClearRequested={this.onParentSuggestionsClearRequested}

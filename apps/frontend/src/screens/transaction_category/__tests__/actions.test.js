...
describe('Transaction Category Actions', () => {
  ...
  describe('getTransactionList', () => {
    ...
    it('should include parent transaction category in payload', async () => {
      ...
      expect(
        dispatchedActions[0].payload[0].parentTransactionCategory.transactionCategoryDescription
      ).toBe('Loream Ipsume');
    });
    ...
    it('should handle API errors', async () => {
      ...
      await expect(store.dispatch(actions.getTransactionList())).rejects.toThrow(
  ...
  describe('deleteTransaction', () => {
    ...
    it('should handle deletion of non-existent transaction', async () => {
      ...
      await expect(store.dispatch(actions.deleteTransaction(999))).rejects.toThrow(
  ...
  describe('Error handling', () => {
    ...
    it('should handle connection refused errors', async () => {
      ...
      await expect(store.dispatch(actions.deleteTransaction(1))).rejects.toThrow(
        'Connection refused'
      );
    });
  });

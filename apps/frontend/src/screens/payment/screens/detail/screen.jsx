...
const DetailPayment = ({
	...
	const deletePayment = () => {
		...
		const message =
			'This payments will be deleted permanently and cannot be recovered. ';
		setDialog(
			<ConfirmDeleteModal
				isOpen={true}
									...
									<Row>
										<Col lg={12}>
											<div className="h4 mb-0 d-flex align-items-center">
												...
												<span className="ml-2">
													{strings.Update + ' ' + strings.Payment}
												</span>
											</div>
										</Col>
									</Row>
															...
															<Controller
																...
																render={({ field }) => (
																	<Input
																		...
																		className={
																			errors.invoiceAmount ? 'is-invalid' : ''
																		}
																	/>
																)}
															/>

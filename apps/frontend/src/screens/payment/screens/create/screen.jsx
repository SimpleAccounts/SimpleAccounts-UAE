...
const CreatePayment = () => {
	...
	const getList = (id) => {
		dispatch(CreatePaymentActions.getList(id))
			...
			.catch((err) => {
				dispatch(CommonActions.tostifyAlert(
					'error',
									...
									<Row>
										<Col lg={4}>
											<FormGroup className="mb-3">
												<Label htmlFor="contactId"><span className="text-danger">* </span>{strings.SupplierName}</Label>
												<Controller
													name="contactId"
													control={control}
													render={({ field }) => (
											...
											{data1.length > 0 ? (
												<div>
													<Row>
														<Col lg={4}>
															<FormGroup className="mb-3">
																<Label htmlFor="amount"><span className="text-danger">* </span>{strings.AmountPaid}</Label>
																<Controller
																	name="amount"
																	control={control}
																	render={({ field }) => (
													...
													<Row>
														<Col lg={4}>
															<FormGroup className="mb-3">
																<Label htmlFor="paymentDate"><span className="text-danger">* </span>{strings.PaymentDate}</Label>
																<Controller
																	name="paymentDate"
																	control={control}
																	render={({ field }) => (
													...
													<Row>
														<Col lg={4}>
															<FormGroup className="mb-3">
																<Label><span className="text-danger">* </span> {strings.PaymentMode}</Label>
																<Controller
																	name="payMode"
																	control={control}
																	render={({ field }) => (
														...
														<Col lg={4}>
															<FormGroup className="mb-3">
																<Label htmlFor="depositeTo"><span className="text-danger">* </span> {strings.DepositTo}</Label>
																<Controller
																	name="depositeTo"
																	control={control}
																	render={({ field }) => (
													...
													<Row className="mt-5">
														<Col lg={12} className="text-right">
															...
															<Button type="button" color="secondary" className="btn-square" onClick={() => navigate('/admin/expense/payment')}>
																{strings.Cancel}
															</Button>
														</Col>
													</Row>

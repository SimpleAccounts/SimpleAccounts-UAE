...
describe('Payment Actions', () => {
  ...
  describe('getBankList', () => {
    ...
    it('should handle bank list fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getBankList())).rejects.toThrow('Failed to fetch banks');
    });
  });
  ...
  describe('getSupplierContactList', () => {
    ...
    it('should handle supplier list fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getSupplierContactList(1))).rejects.toThrow(
  ...
  describe('getSupplierInvoiceList', () => {
    ...
    it('should handle invoice list fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getSupplierInvoiceList())).rejects.toThrow(
  ...
  describe('getPaymentList', () => {
    ...
    it('should handle fetch error', async () => {
      ...
      await expect(store.dispatch(actions.getPaymentList({}))).rejects.toThrow('Network error');
    });
  });
  ...
  describe('removeBulkPayments', () => {
    ...
    it('should handle bulk delete error', async () => {
      ...
      await expect(store.dispatch(actions.removeBulkPayments({ ids: [1, 2] }))).rejects.toThrow(
        'Delete failed'
      );
    });
  });
  ...
  describe('Error Handling', () => {
    it('should handle network timeout', async () => {
      ...
      await expect(store.dispatch(actions.getPaymentList({}))).rejects.toThrow('Request timeout');
    });
    ...
    it('should handle 401 unauthorized error', async () => {
      ...
      await expect(store.dispatch(actions.getBankList())).rejects.toThrow('Unauthorized');
    });

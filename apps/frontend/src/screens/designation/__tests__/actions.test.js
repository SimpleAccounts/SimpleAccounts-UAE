...
describe('Designation Actions', () => {
  ...
  describe('getEmployeeDesignationList', () => {
    ...
    it('should return response on success', async () => {
      ...
      const result = await store.dispatch(actions.getEmployeeDesignationList({ pageNo: 1 }));
    ...
    it('should handle API errors gracefully', async () => {
      ...
      await expect(store.dispatch(actions.getEmployeeDesignationList(postObj))).rejects.toThrow(
  ...
  describe('getParentDesignationList', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await expect(store.dispatch(actions.getParentDesignationList())).rejects.toThrow(
        'Failed to fetch parent designations'
      );
    });
  ...
  describe('getEmployeeCountForDesignation', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await expect(store.dispatch(actions.getEmployeeCountForDesignation(123))).rejects.toThrow(
  ...
  describe('Action error handling', () => {
    it('should propagate API errors correctly for getEmployeeDesignationList', async () => {
      ...
      await expect(actions.getEmployeeDesignationList({ pageNo: 1 })(dispatch)).rejects.toThrow(
        'API Error'
      );
    });
    ...
    it('should handle network errors', async () => {
      ...
      await expect(actions.getEmployeeDesignationList({ pageNo: 1 })(jest.fn())).rejects.toThrow();
      await expect(actions.getParentDesignationList()(jest.fn())).rejects.toThrow();
      await expect(actions.getEmployeeCountForDesignation(1)(jest.fn())).rejects.toThrow();
    });
  });
});

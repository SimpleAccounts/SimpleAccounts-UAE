...
describe('ReportsReducer', () => {
  ...
  describe('PURCHASE_BY_ITEM', () => {
    it('should handle PURCHASE_BY_ITEM action', () => {
      const payload = {
        data: [{ itemId: 1, itemName: 'Raw Material A', quantityPurchased: 500, cost: 5000 }],
      };
  ...
  describe('PAYABLE_INVOICE', () => {
    it('should handle PAYABLE_INVOICE action', () => {
      const payload = {
        data: [{ invoiceId: 1, vendorName: 'Vendor A', amount: 10000, dueDate: '2024-02-01' }],
      };
  ...
  describe('CREDITNOTE_DETAILS', () => {
    it('should handle CREDITNOTE_DETAILS action', () => {
      const payload = {
        data: [{ creditNoteId: 1, customerName: 'Customer A', amount: 500, reason: 'Return' }],
      };
  ...
  describe('CTREPORT_LIST', () => {
    it('should handle CTREPORT_LIST action', () => {
      const payload = {
        data: [{ reportId: 1, name: 'Corporate Tax Report Q1', status: 'Filed' }],
      };

...
describe('Financial Report Actions', () => {
  ...
  describe('getCustomerAccountStatement', () => {
    it('should call API with contactId parameter', async () => {
      ...
      const result = await store.dispatch(actions.getCustomerAccountStatement(postData));
  ...
  describe('getCompany', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await expect(store.dispatch(actions.getCompany())).rejects.toThrow('Failed to fetch company');
    });
  });
  ...
  describe('getColumnConfigs', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await expect(store.dispatch(actions.getColumnConfigs({ id: 1 }))).rejects.toThrow(
        'Failed to fetch column configs'
      );
    });
  });
  ...
  describe('updateColumnConfigs', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await expect(store.dispatch(actions.updateColumnConfigs({ id: 1 }))).rejects.toThrow(
        'Failed to update column configs'
      );
    });
  });
  ...
  describe('Error handling across all actions', () => {
    ...
    it('should handle unauthorized errors', async () => {
      ...
      await expect(store.dispatch(actions.getCompany())).rejects.toThrow('Unauthorized');
    });

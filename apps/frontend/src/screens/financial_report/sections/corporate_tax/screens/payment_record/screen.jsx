...
const createPaymentRecordSchema = (totalAmount, balanceDue) => z.object({
	receiptNo: z.string().optional(),
	paymentDate: z.union([z.string(), z.date()]).refine((val) => val !== null && val !== '', 'Payment date is required'),
	...
	paidThrough: z.object({
		...
		label: z.string(),
	}).nullable().refine((val) => val !== null, 'Paid through is required'),
	referenceNumber: z.string().optional(),
	attachmentFile: z.custom((value) => value instanceof File || value === undefined || value === null || value === '', {
...
const CorporateTaxPaymentRecord = (props) => {
	...
	const totalAmount = locationState.totalAmount || 0.00;
	...
	const handleFormSubmit = (data) => {
		...
		props.ctReportActions.recordCTPayment(postData)
			.then((res) => {
				if (res.status === 200) {
															...
															<Controller
																...
																render={({ field: { onChange, value } }) => (
																	<DatePicker
																		...
																		dropdownMode="select"
																		selected={value ? (typeof value === 'string' ? new Date(value) : value) : reportFilledOn}

...
const CTReport = props => {
  ...
  const generateCTReport = () => {
    ...
    props.ctReportActions
      ...
      .then(res => {
        if (res.status === 200) {
          props.commonActions.tostifyAlert('success', 'Report Created Successfully!');
        }
        setCtReprtFor(null);
        closeModal(false);
      })
          ...
          <Row>
            <Col lg={12}>
              <div className="h4 mb-0 d-flex align-items-center">
                <span className="ml-2">{strings.GenerateCorporateTaxReport}</span>
              </div>
            </Col>
          </Row>
        </ModalHeader>
                    ...
                    <Form>
                      <Row>
                        <Col lg={4} className=" pull-right ">
                          <Label>{strings.ReportingPeriod}</Label>
                          <Select
                            isDisabled={true}
                      ...
                      <Row style={{ marginTop: 20 }}>
                        ...
                        <Col lg={4}>
                          <FormGroup className="mb-3">
                            <Label htmlFor="dueDate">{strings.DueDate}</Label>
                            <DatePicker
                              disabled
                              id="dueDate"
                              name="dueDate"
...
export default connect(mapStateToProps, mapDispatchToProps)(CTReport);

...
const CTSettingModal = props => {
  ...
  const saveCTSettings = () => {
    ...
    props.ctReportActions
      ...
      .then(res => {
        if (res.status === 200) {
          props.commonActions.tostifyAlert('success', 'Settings Saved Successfully!');
          ...
          <Row>
            <Col lg={12}>
              <div className="h4 mb-0 d-flex align-items-center">
                <span className="ml-2">{strings.CorporateTaxSetting}</span>
              </div>
            </Col>
          </Row>
        </ModalHeader>
                ...
                {loading ? (
                  ...
                  <>
                    <Form>
                          ...
                          <div className="wrapper">
                            <Label className="form-check-label ml-4 mr-5 " check>
                              <Input
                                ...
                                value={true}
                                checked={
                                  isEligibleForCP === 'true' || previousSettings?.isEligibleForCP
                                }
                                onChange={e => {
                            ...
                            <Label className="form-check-label" check>
                              <Input
                                ...
                                value={false}
                                checked={
                                  isEligibleForCP === 'false' || !previousSettings?.isEligibleForCP
                                }
                                onChange={e => {
                          ...
                          <Select
                            ...
                            value={
                              fiscalYear
                                ...
                                : previousSettings
                                  ? {
                                      value: previousSettings?.corporateTaxSettingId,
                                      label: previousSettings?.fiscalYear,
                                    }
                                  : fiscalYearOptions[0]
                            }
                            onChange={e => {
                      ...
                      <br></br>
                      <b>Note:</b> Once the corporate tax report has been created, the settings
                      cannot be changed
                    </Form>
                  </>
                )}
...
export default connect(mapStateToProps, mapDispatchToProps)(CTSettingModal);

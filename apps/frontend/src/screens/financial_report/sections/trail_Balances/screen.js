...
class TrailBalances extends React.Component {
  ...
  totalAssets = () => {
    ...
    return (
      <tr style={{ backgroundColor: '#B4C6E7' }}>
        <td className="pt-1 pb-1 bld">{strings.Total + ' ' + strings.Assets}</td>
        <td className="text-right pt-1 pb-1 bld">
          <Currency
            value={totalDebit ? totalDebit : 0.0}
            currencyCode={
        ...
        <td className="pt-1 pb-1 text-right bld">
          <Currency
            value={totalCredit ? totalCredit : 0.0}
            currencyCode={
              this.props.universal_currency_list[0]
                ? this.props.universal_currency_list[0].currencyIsoCode
                : 'AED'
  ...
  totalLiabilities = () => {
    ...
    return (
      <tr style={{ backgroundColor: '#B4C6E7' }}>
        <td className="pt-1 pb-1 bld">{strings.Total + ' ' + strings.Liabilities}</td>
        <td className="text-right pt-1 pb-1 bld">
          <Currency
            value={totalDebit ? totalDebit : 0.0}
            currencyCode={
  ...
  totalEquities = () => {
    ...
    return (
      <tr style={{ backgroundColor: '#B4C6E7' }}>
        <td className="pt-1 pb-1 bld">{strings.Total + ' ' + strings.Equities}</td>
        <td className="text-right pt-1 pb-1 bld">
          <Currency
            value={totalDebit ? totalDebit : 0.0}
            currencyCode={
  ...
  totalIncome = () => {
    ...
    return (
      <tr style={{ backgroundColor: '#B4C6E7' }}>
        <td className="pt-1 pb-1 bld">{strings.Total + ' ' + strings.Income}</td>
        <td className="text-right pt-1 pb-1 bld">
          <Currency
            value={totalDebit ? totalDebit : 0.0}
            currencyCode={
  ...
  totalExpense = () => {
    ...
    return (
      <tr style={{ backgroundColor: '#B4C6E7' }}>
        <td className="pt-1 pb-1 bld">{strings.Total + ' ' + strings.Expense}</td>
        <td className="text-right pt-1 pb-1 bld">
          <Currency
            value={totalDebit ? totalDebit : 0.0}
            currencyCode={
                  ...
                  >
                    ...
                    <div style={{ textAlign: 'center' }}>
                      ...
                      <b style={{ fontSize: '18px' }}>
                        {strings.TrailBalances + ' ' + strings.Report}
                      </b>
                      <br style={{ marginBottom: '5px' }} />
                      {customPeriod === 'asOn'
                  ...
                  {loading ? (
                    ...
                    <div className="table-wrapper" style={{ width: '1000px', margin: '0 auto' }}>
                      <Table
                        ...
                        responsive
                        className="tb-table-bordered table"
                      >
                        <thead>
                          ...
                          {Object.keys(this.state.data).length > 0 ? (
                            <>
                              ...
                              <tr style={{ backgroundColor: '#4472C4' }}>
                                <td className="wh pt-1 pb-1 bld" colSpan={3}>
                                  {strings.Assets}
                                </td>
                              </tr>
                              {Object.keys(this.state.data['accountReceivable']).map(item => {
                                ...
                                return (
                                  <tr>
                                    ...
                                    <td className="pt-0 pb-0 text-right">
                                      {this.state.data['transactionCategoryMapper'][`${item}`] ===
                                      'Debit'
                                        ? this.state.data['bank'][`${item}`].toLocaleString(
                                            navigator.language,
                                ...
                                return (
                                  <tr>
                                    ...
                                    <td className="pt-0 pb-0 text-right">
                                      {this.state.data['transactionCategoryMapper'][`${item}`] ===
                                      'Debit'
                                        ? this.state.data['fixedAsset'][`${item}`].toLocaleString(
                                            navigator.language,
                                            { minimumFractionDigits: 2, maximumFractionDigits: 2 }
                                          )
                                        : ''}
                                ...
                                return (
                                  <tr>
                                    ...
                                    <td className="pt-0 pb-0 text-right">
                                      {this.state.data['transactionCategoryMapper'][`${item}`] ===
                                      'Debit'
                                        ? this.state.data['assets'][`${item}`].toLocaleString(
                                            navigator.language,
                                            { minimumFractionDigits: 2, maximumFractionDigits: 2 }
                                          )
                                        : ''}
                                ...
                                return (
                                  <tr>
                                    ...
                                    <td className="pt-0 pb-0 text-right">
                                      {this.state.data['transactionCategoryMapper'][`${item}`] ===
                                      'Debit'
                                        ? this.state.data['liabilities'][`${item}`].toLocaleString(
                                            navigator.language,
                                            { minimumFractionDigits: 2, maximumFractionDigits: 2 }
                                          )
                                        : ''}
                                ...
                                return (
                                  <tr>
                                    ...
                                    <td className="pt-0 pb-0 text-right">
                                      {this.state.data['transactionCategoryMapper'][`${item}`] ===
                                      'Debit'
                                        ? this.state.data['equities'][`${item}`].toLocaleString(
                                            navigator.language,
                                            { minimumFractionDigits: 2, maximumFractionDigits: 2 }
                                          )
                                        : ''}
                                ...
                                return (
                                  <tr>
                                    ...
                                    <td className="pt-0 pb-0 text-right">
                                      {this.state.data['transactionCategoryMapper'][`${item}`] ===
                                      'Debit'
                                        ? this.state.data['income'][`${item}`].toLocaleString(
                                            navigator.language,
                                            { minimumFractionDigits: 2, maximumFractionDigits: 2 }
                                          )
                                        : ''}
                                ...
                                return (
                                  <tr>
                                    ...
                                    <td className="pt-0 pb-0 text-right">
                                      {this.state.data['transactionCategoryMapper'][`${item}`] ===
                                      'Debit'
                                        ? this.state.data['expense'][`${item}`].toLocaleString(
                                            navigator.language,
                                            { minimumFractionDigits: 2, maximumFractionDigits: 2 }
                                          )
                                        : ''}

...
class PayablesInvoiceDetailsReport extends React.Component {
  ...
  getList = paybaleInvoiceDetailsList => {
    ...
    paybaleInvoiceDetailsList &&
      paybaleInvoiceDetailsList.length > 0 &&
      paybaleInvoiceDetailsList.map(item => {
...
export default connect(mapStateToProps, mapDispatchToProps)(PayablesInvoiceDetailsReport);

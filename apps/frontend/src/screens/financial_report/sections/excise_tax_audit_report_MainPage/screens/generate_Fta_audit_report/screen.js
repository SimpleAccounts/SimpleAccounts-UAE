...
class GenerateAuditFile extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      vatReportDataList: [
        {
          taxReturns: 'Sept 2021',
          dateOfFiling: '1st Jan 2022',
          amountPaid: 3600,
          amountReclaimed: '---',
        },
        {
          ...
          dateOfFiling: '1st Jan 2022',
          amountPaid: '---',
          amountReclaimed: 7300,
        },
        {
          taxReturns: 'Nov 2021',
          dateOfFiling: '1st Jan 2022',
          amountPaid: '---',
          amountReclaimed: 3500,
        },
        {
          taxReturns: 'Dec 2021',
          dateOfFiling: '1st Jan 2022',
              ...
              <Formik
                ...
                validate={values => {
                  ...
                  if (
                    ...
                    (values.taxAgencyNumber == '' || values.taxAgencyNumber == undefined)
                  ) {
                ...
                validationSchema={Yup.object().shape({
                  ...
                  taxablePersonNameInEnglish: Yup.string().required(
                    'Taxable person name in english is required'
                  ),
                  taxablePersonNameInArabic: Yup.string().required(
                    'Taxable person name in arabic is required'
                  ),
                  taxAgentApprovalNumber: Yup.string().required(
                    'Tax agent approval number is required'
                  ),
                          ...
                          <Col lg={4}>
                            <FormGroup className="mb-3">
                              ...
                              <Input
                                ...
                                onChange={option => props.handleChange('taxAgentName')(option)}
                                defaultValue={props.values.taxAgentName}
                              />

                              {props.errors.taxAgentName && (
                                <div className="text-danger">{props.errors.taxAgentName}</div>
                              )}
                            </FormGroup>
                          </Col>
                        </Row>
                          ...
                          <Col lg={4}>
                            <FormGroup className="mb-3">
                              ...
                              {props.errors.taxAgencyNumber && (
                                <div className="text-danger">{props.errors.taxAgencyNumber}</div>
                              )}
                            </FormGroup>
                          </Col>
                          <Col lg={4}>
                            ...
                            <FormGroup className="mb-3">
                              ...
                              <DatePicker
                                ...
                                className={`form-control ${
                                  props.errors.taxFiledOn && props.touched.taxFiledOn
                                    ? 'is-invalid'
                                    : ''
                                }`}
                              />
                              {props.errors.taxFiledOn && (
                                <div className="text-danger">{props.errors.taxFiledOn}</div>
                              )}
                            </FormGroup>
                          </Col>
                        </Row>

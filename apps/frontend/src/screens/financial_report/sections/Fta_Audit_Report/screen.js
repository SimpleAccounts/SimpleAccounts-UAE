    ...
    this.props.financialReportActions
      ...
      .then(res => {
        ...
        if (res.status === 200) {
          ...
          this.setState({ FtaAuditData: res.data, csvData: tempData }, () => {
            this.setState({
              loading: false,
            });
          });
...
export default connect(mapStateToProps, mapDispatchToProps)(ViewFtaAuditReport);

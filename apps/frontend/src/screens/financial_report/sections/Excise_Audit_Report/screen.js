...
class ViewFtaExciseAuditReport extends React.Component {
    ...
    this.props.financialReportActions
      ...
      .then(res => {
        ...
        if (res.status === 200) {
          ...
          // 	return item;
          // });
          this.setState({ FtaExciseAuditData: res.data, csvData: tempData }, () => {
            this.setState({
              loading: false,
            });
          });
  ...
  render() {
    const { loading, dropdownOpen } = this.state;
                  ...
                  <Col lg={12}>
                    ...
                    >
                      <div>
                        ...
                        >
                          FTA Excise Tax Audit File From{' '}
                          <b>
                            {this.state.initValue.startDate.replaceAll('/', '-') +
                              '  to  ' +
                    ...
                    <div id="tbl_exporttable_to_xls" className="table-wrapper">
                      <Table responsive>
                        ...
                        <tr>
                          <td>
                            <b>
                              <h5>Company Information Table</h5>
                            </b>
                          </td>
                        </tr>
                        <tr></tr>
                        ...
                        <tr>
                          <td>
                            <b>
                              <h5>Costumer Data Audit File</h5>
                            </b>
                          </td>
                        </tr>
                        <tr></tr>
                        ...
                        <tr>
                          <td>
                            <b>
                              <h5>Supplier Data Audit File</h5>
                            </b>
                          </td>
                        </tr>
                        <tr></tr>
                        ...
                        <tr>
                          <td>
                            <b>
                              <h5>General Ledger Table Total</h5>
                            </b>
                          </td>
                        </tr>
                        <Table>
...
export default connect(mapStateToProps, mapDispatchToProps)(ViewFtaExciseAuditReport);

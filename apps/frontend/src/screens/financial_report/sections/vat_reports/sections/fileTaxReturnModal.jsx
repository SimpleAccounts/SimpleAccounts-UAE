...
const FileTaxReturnModalForm = ({
	...
	const {
		...
		resolver: zodResolver(createValidationSchema(FTAExciseTaxAuditFile, FTAVatAuditFile, isTANMandetory)),
		defaultValues: {
			...initValue,
			taxFiledOn: new Date(),
		},
	...
	return (
		<Form onSubmit={handleSubmit(handleFormSubmit)}>
			<ModalBody>
				<Row className="mb-4">
					<Col>
						<h4>Once report is filed, you won't be able to edit any transactions for this tax period.</h4>
					</Col>
				</Row>
				<Row>
					<Col lg={4}>

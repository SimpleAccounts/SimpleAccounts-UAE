...
const createRecordTaxClaimSchema = (totalTaxReclaimable) => z.object({
	...
	depositeTo: z.object({
		...
		label: z.string(),
	}).nullable().refine((val) => val !== null, 'Deposit to is required'),
...
const RecordTaxClaim = (props) => {
	...
	const totalTaxReclaimable = locationState.totalTaxReclaimable || 0.00;
	...
	const handleFormSubmit = (data) => {
		...
		props.vatreportActions.recordVatPayment(formData)
			.then((res) => {

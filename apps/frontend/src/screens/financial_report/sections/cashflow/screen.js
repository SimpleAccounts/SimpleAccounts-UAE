                  ...
                  {loading ? (
                    ...
                    <div className="table-wrapper" style={{ width: '1000px', margin: '0 auto' }}>
                      <Table
                        ...
                        responsive
                        className="cashflow-table-bordered"
                      >
                        <thead>
                          <tr>
                            {this.columnHeader.map((column, index) => {
                              return (
                                <th key={index} className={column.class ? 'text-right th' : 'th'}>
                                  {column.label}
                                </th>
                              );
                            })}
                          ...
                          {Object.keys(this.state.data).length > 0 ? (
                            <>
                              ...
                              <tr>
                                ...
                                <td className="pt-0 pb-0 text-right">
                                  {this.state.data['netIncome'] != null ? (
                                    <Currency
                                      value={this.state.data['netIncome']}
                                      currencySymbol={
                                        universal_currency_list[0]
                                          ? universal_currency_list[0].currencyIsoCode
                                          : 'AED'
                              ...
                              <tr style={{ backgroundColor: '#B4C6E7' }}>
                                ...
                                <td className="text-right pt-1 pb-1 bld">
                                  {this.state.data['totalInvestingActivities'] != null ? (
                                    <Currency
                                      value={this.state.data['totalInvestingActivities']}
                                      currencySymbol={
                                        universal_currency_list[0]
                                          ? universal_currency_list[0].currencyIsoCode
                                          : 'USD'
                              ...
                              <tr style={{ backgroundColor: '#B4C6E7' }}>
                                ...
                                <td className="text-right pt-1 pb-1 bld">
                                  {this.state.data['totalFinancingActivities'] != null ? (
                                    <Currency
                                      value={this.state.data['totalFinancingActivities']}
                                      currencySymbol={
                                        universal_currency_list[0]
                                          ? universal_currency_list[0].currencyIsoCode
                                          : 'USD'
                              ...
                              <tr style={{ backgroundColor: '#9CC2E5' }}>
                                <td className="pt-1 pb-1 bld">
                                  {strings.Starting + ' ' + strings.Balance}
                                </td>
                                <td className="text-right pt-1 pb-1 bld">
                              ...
                              <tr>
                                ...
                                <td className="text-right pt-1 pb-1 bld">
                                  {this.state.data['grossCashInflow'] != null ? (
                                    <Currency
                                      value={this.state.data['grossCashInflow']}
                                      currencySymbol={
                                        universal_currency_list[0]
                                          ? universal_currency_list[0].currencyIsoCode
                                          : 'USD'
                              ...
                              <tr>
                                ...
                                <td className="text-right pt-1 pb-1 bld">
                                  {this.state.data['grossCashOutflow'] != null ? (
                                    <Currency
                                      value={this.state.data['grossCashOutflow']}
                                      currencySymbol={
                                        universal_currency_list[0]
                                          ? universal_currency_list[0].currencyIsoCode
                                          : 'USD'
                              ...
                              <tr>
                                ...
                                <td className="text-right pt-1 pb-1 bld">
                                  {this.state.data['netCashChange'] != null ? (
                                    <Currency
                                      value={this.state.data['netCashChange']}
                                      currencySymbol={
                                        universal_currency_list[0]
                                          ? universal_currency_list[0].currencyIsoCode
                                          : 'USD'
                              ...
                              <tr style={{ backgroundColor: '#9CC2E5' }}>
                                <td className="pt-1 pb-1 bld">
                                  {strings.Ending + ' ' + strings.Balance}
                                </td>
                                <td className="text-right pt-1 pb-1 bld">
                                  {this.state.data['endingBalance'] != null ? (
                                    <Currency
                                      value={this.state.data['endingBalance']}
                                      currencySymbol={
                                        universal_currency_list[0]
                                          ? universal_currency_list[0].currencyIsoCode
                                          : 'USD'

...
const mapDispatchToProps = dispatch => {
  return {
    receivbaleInvoiceDetailsActions: bindActionCreators(ReceivbaleInvoiceDetailsActions, dispatch),
  };
};
...
class ReceivableInvoiceDetailsReport extends React.Component {
  ...
  getList = receivbaleInvoiceDetailsList => {
    ...
    let id = 0;
    receivbaleInvoiceDetailsList &&
      receivbaleInvoiceDetailsList.length > 0 &&
      receivbaleInvoiceDetailsList.map(item => {
...
export default connect(mapStateToProps, mapDispatchToProps)(ReceivableInvoiceDetailsReport);

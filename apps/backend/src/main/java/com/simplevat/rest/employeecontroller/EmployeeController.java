...
import com.simplevat.repository.EmployeeSalaryComponentRelationRepository;
import com.simplevat.rest.CorporateTax.CorporateTaxFiling;
import com.simplevat.rest.DropdownModel;
import com.simplevat.rest.DropdownObjectModel;
import com.simplevat.rest.PaginationResponseModel;
import com.simplevat.rest.payroll.PayrollRestHepler;
...
public class EmployeeController {
	...
	public ResponseEntity<?> deleteEmployee(@RequestParam(value = "id") Integer id) {
		try {
			...
			message = new SimpleVatMessage("0073",
	...
	public ResponseEntity<?> save(@ModelAttribute EmployeePersistModel employeePersistModel, HttpServletRequest request) {
		...
		try {
			...
			if (existingEmployee != null && !existingEmployee.isEmpty()) {
				message = new SimpleVatMessage("0012",
...
//			employmentService.persist(employment);
			...
			message = new SimpleVatMessage("0071",
 ...
 */
			...
			message = new SimpleVatMessage("0072",
...
//
	...
	public ResponseEntity<?> getEmployeeInviteEmail(@RequestParam(value = "id") Integer employeeId , HttpServletRequest request){
		try {
			...
			employeeService.sendInvitationMail(employee, request);
			message = new SimpleVatMessage("","Employee Invite Mail Sent Successfully", true);
			return new ResponseEntity<>(message,HttpStatus.OK);
		} catch (Exception e) {
			SimpleVatMessage message= null;
			message = new SimpleVatMessage("","Employee Invite Mail Sent UnSuccessfully", true);
			return new ResponseEntity<>( message,HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
}

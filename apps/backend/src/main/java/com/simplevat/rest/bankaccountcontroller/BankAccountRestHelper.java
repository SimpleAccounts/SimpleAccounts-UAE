...
import com.simplevat.repository.TransactionRepository;
	...
	public BankModel getModel(BankAccount bank) {
		...
		if (bank != null) {
			...
			if (bank.getOpeningDate() != null) {
				...
				//openingDate = LocalDateTime.ofInstant(ZoneId.of(System.getProperty("simplevat.user.timezone","Asia/Dubai")));

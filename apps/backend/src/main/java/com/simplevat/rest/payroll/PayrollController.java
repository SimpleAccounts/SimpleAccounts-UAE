...
import com.simplevat.model.EmployeeBankDetailsPersistModel;
import com.simplevat.model.EmploymentPersistModel;
import com.simplevat.repository.*;
import com.simplevat.rest.*;
import com.simplevat.rest.invoicecontroller.InvoiceRequestFilterModel;
import com.simplevat.rest.payroll.dto.PayrollEmployeeDto;
import com.simplevat.rest.payroll.model.GeneratePayrollPersistModel;
import com.simplevat.rest.payroll.model.PayrolRequestModel;
import com.simplevat.rest.payroll.model.PayrollEmployeeModel;
import com.simplevat.rest.payroll.model.PayrollListModel;
import com.simplevat.rest.payroll.payrolService.PayrolService;
...
//#################################################################################################################################################################################
    ...
    public ResponseEntity<String> saveSalaryTemplate(@ModelAttribute SalaryTemplatePersistModel salaryTemplatePersistModel, HttpServletRequest request) {
        try {
            ...
            List<com.simplevat.entity.SalaryTemplate> existingComponentId = salaryTemplateService.findByAttributes(param);
...
//
    ...
    public ResponseEntity<SalaryTemplatePersistModel> getSalaryTemplateById(@RequestParam(value = "id") Integer id) {
        try {
            com.simplevat.entity.SalaryTemplate salaryTemplate = salaryTemplateService.findByPK(id);
            if (salaryTemplate == null) {
                return new ResponseEntity<>(HttpStatus.NOT_FOUND);
            } else {

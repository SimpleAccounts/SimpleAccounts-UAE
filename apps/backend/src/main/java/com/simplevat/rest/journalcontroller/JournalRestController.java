...
import com.simplevat.repository.CustomerInvoiceReceiptRepository;
import com.simplevat.repository.JournalLineItemRepository;
import com.simplevat.repository.JournalRepository;
import com.simplevat.repository.SupplierInvoicePaymentRepository;
...
import static com.simplevat.constant.PostingReferenceTypeEnum.*;
...
//						.atZone(ZoneId.systemDefault()).toLocalDateTime();
	...
	public ResponseEntity<?> deleteJournal(@RequestParam(value = "id") Integer id) {
		...
		message = new SimpleVatMessage("0080",
...
//		return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
	...
	public ResponseEntity<?> save(@RequestBody JournalRequestModel journalRequestModel, HttpServletRequest request) {
		try {
			...
			SimpleVatMessage message = null;
			message = new SimpleVatMessage("0079",
	...
	public ResponseEntity<?> update(@RequestBody JournalRequestModel jouralRequestModel, HttpServletRequest request) {
		try {
			...
			journalService.update(journal);
			SimpleVatMessage message = null;
			message = new SimpleVatMessage("0081",

...
//						} else {
	...
	public List<com.simplevat.entity.bankaccount.Transaction> getEntityWithoutTemplate(TransactionImportModel transactionImportModel) {
...
//			DateFormat dateFormat = dateFormatService.findByPK(transactionImportModel.getDateFormatId());
			...
			com.simplevat.entity.DateFormat dateFormat = dateFormatService.findByPK(transactionImportModel.getDateFormatId());

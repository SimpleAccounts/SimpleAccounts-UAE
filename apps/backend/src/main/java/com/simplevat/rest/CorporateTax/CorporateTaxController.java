...
import com.simplevat.aop.LogExecutionTime;
...
import com.simplevat.rest.CorporateTax.Model.CorporateTaxDateModel;
...
import com.simplevat.rest.CorporateTax.Repositories.CorporateTaxSettingRepository;
import com.simplevat.rest.PaginationResponseModel;
import com.simplevat.rest.companycontroller.CompanyRestHelper;
...
import com.simplevat.rfq_po.PoQuatationController;
...
//            corporateTaxModel.setViewCtReport(corporateTaxFiling.getViewCtReport());
    ...
    public ResponseEntity<?> delete(@RequestParam(value = "id") Integer id) {
        try {
            ...
            corporateTaxFilingRepository.save(corporateTaxFiling);
            message = new SimpleVatMessage("0091",

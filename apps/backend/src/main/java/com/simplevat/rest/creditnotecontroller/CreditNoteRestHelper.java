...
import com.simplevat.rest.invoicecontroller.InvoiceListModel;
...
import static com.simplevat.rest.invoicecontroller.HtmlTemplateConstants.REFUND_CD_TEMPLATE;
...
public SimpleVatMessage recordPaymentForCN(RecordPaymentForCN requestModel, Integer userId, SimpleVatMessage message,HttpServletRequest request) {
    ...
    message = new SimpleVatMessage("0082",

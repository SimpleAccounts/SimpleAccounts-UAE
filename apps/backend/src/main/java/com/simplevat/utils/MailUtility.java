...
import com.simplevat.rest.MailController.EmailContentModel;
...
public class MailUtility {
	...
	public static JavaMailSender getJavaMailSender(MailConfigurationModel mailConfigurationModel) {
		...
		sender.setHost(mailConfigurationModel.getMailhost() != null ? mailConfigurationModel.getMailhost() : System.getenv("SIMPLEVAT_SMTP_AUTH"));
		sender.setPort(mailConfigurationModel.getMailport() != null ? Integer.parseInt(mailConfigurationModel.getMailport()) :Integer.parseInt(System.getenv("SIMPLEVAT_SMTP_PORT")));
		sender.setUsername(mailConfigurationModel.getMailusername() != null ? mailConfigurationModel.getMailusername() : System.getenv("SIMPLEVAT_SMTP_USER"));
		sender.setPassword(mailConfigurationModel.getMailpassword() != null ? mailConfigurationModel.getMailpassword() : System.getenv("SIMPLEVAT_SMTP_PASS"));
		Properties mailProps = new Properties();
		mailProps.put("mail.smtps.auth",mailConfigurationModel.getMailsmtpAuth() != null ? mailConfigurationModel.getMailsmtpAuth() : System.getenv("SIMPLEVAT_SMTP_AUTH"));
		mailProps.put("mail.transport.protocol", "smtp");
		mailProps.put("mail.smtps.host", mailConfigurationModel.getMailhost() != null ? mailConfigurationModel.getMailhost() : System.getenv("SIMPLEVAT_SMTP_HOST"));
		mailProps.put("mail.smtp.starttls.enable",mailConfigurationModel.getMailstmpStartTLSEnable() != null ? mailConfigurationModel.getMailstmpStartTLSEnable(): System.getenv("SIMPLEVAT_SMTP_STARTTLS_ENABLE"));
		mailProps.put("mail.smtp.debug", "true");
		mailProps.put("mail.smtp.port",mailConfigurationModel.getMailport() != null ? mailConfigurationModel.getMailport() : System.getenv("SIMPLEVAT_SMTP_PORT"));
//    mailProps.put("mail.smtps.auth", mailConfigurationModel.getMailsmtpAuth());
//    mailProps.put("mail.smtp.socketFactory.port", System.getenv(ConfigurationConstants.SIMPLEVAT_SMTP_PORT));

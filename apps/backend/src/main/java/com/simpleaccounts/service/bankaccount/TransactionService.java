...
public abstract class TransactionService extends SimpleAccountsService<Integer, Transaction>{
    ...
    public abstract Integer getTransactionCountByBankAccountId(Integer bankAccountId);
